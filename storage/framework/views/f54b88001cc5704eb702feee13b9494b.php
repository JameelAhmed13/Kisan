<?php $__env->startSection('css'); ?>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/vendors/apexcharts/dist/apexcharts.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/vendors/simple-datatables/dist/style.css')); ?>">
                    ...
                    <div class="card-body">
                        <div class="img-overlay">
                            ...
                            <p>Welcome to the Edmin family! We are delighted that you have
                                visited our dashboard.</p><a class="btn btn-primary" href="<?php echo e(route('admin.pricing')); ?>">Go Premium</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3">
                <div class="card project-card">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="row align-items-center">
                            <div class="col-5 custom-width">
                                ...
                                <div class="progress progress-striped-secondary">
                                    <div class="progress-bar" style="width: 60%" role="progressbar" aria-valuenow="10"
                                         aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                                <div class="progress progress-striped-tertiary">
                                    <div class="progress-bar" style="width: 45%" role="progressbar" aria-valuenow="10"
                                         aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        ...
                        <button class="view-btn btn bg-light d-block w-100 position-relative" type="button"
                                data-bs-toggle="dropdown" aria-expanded="false">View project
                            <svg class="feather">
                                <use href="<?php echo e(asset('assets/svg/feather-icons/dist/feather-sprite.svg#chevron-down')); ?>">
                                </use>
                            </svg>
                            ...
                            <table class="table" id="all-invoice">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img class="b-r-10"
                                                                            src="<?php echo e(asset('assets/images/avatar/10.jpg')); ?>" alt="">
                                            </div>
                                            <div class="flex-grow-1"><a href="<?php echo e(route('admin.user_profile')); ?>">
                                                    <h6 class="f-w-500">Elle Amberson
                                                    </h6>
                                                </a><span class="font-light f-w-400 f-13">Elle34@gmail.com</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>Website</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img class="b-r-10"
                                                                            src="<?php echo e(asset('assets/images/avatar/11.jpg')); ?>"
                                                                            alt=""></div>
                                            <div class="flex-grow-1"><a href="<?php echo e(route('admin.user_profile')); ?>">
                                                    <h6 class="f-w-500">Anna Catmire
                                                    </h6>
                                                </a><span class="font-light f-w-400 f-13">Anna12@gmail.com</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>Mobile App</td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="flex-grow-1"><a href="<?php echo e(route('admin.user_profile')); ?>">
                                                ...
                                                </a><span class="font-light f-w-400 f-13">Laura@gmail.com</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>Wordpress</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img class="b-r-10"
                                                                            src="<?php echo e(asset('assets/images/avatar/3.jpg')); ?>"
                                                                            alt=""></div>
                                            <div class="flex-grow-1"><a href="<?php echo e(route('admin.user_profile')); ?>">
                                                    <h6 class="f-w-500">Rachel Green
                                                    </h6>
                                                </a><span class="font-light f-w-400 f-13">Rache87@gmail.com</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>Service</td>
                    ...
                    <div class="card-body filled-checkbox">
                        <ul>
                            <li class="d-flex line-primary">
                                ...
                                <div class="flex-grow-1"> <a href="<?php echo e(route('admin.task')); ?>">
                                ...
                                <div class="dropdown task-dropdown">
                                    <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                            aria-expanded="false" id="dorpdown44">
                                        <svg class="feather">
                                            <use
                                                href="<?php echo e(asset('assets/svg/feather-icons/dist/feather-sprite.svg#more-horizontal')); ?>">
                                            </use>
                                        </svg>
                                    </button>
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dorpdown44"><a
                                            class="dropdown-item" href="#">Weekly</a><a class="dropdown-item"
                            ...
                            <li class="d-flex line-secondary">
                                ...
                                <div class="dropdown task-dropdown">
                                    <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                            aria-expanded="false" id="dorpdown55">
                                        <svg class="feather">
                                            <use
                                                href="<?php echo e(asset('assets/svg/feather-icons/dist/feather-sprite.svg#more-horizontal')); ?>">
                                            </use>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dorpdown55"><a
                                            class="dropdown-item" href="#">Weekly</a><a class="dropdown-item"
                                                                                        href="#">Monthly</a><a class="dropdown-item" href="#">Yearly</a>
                                    </div>
                                </div>
                            ...
                            <li class="d-flex line-tertiary">
                                ...
                                <div class="dropdown task-dropdown">
                                    <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                            aria-expanded="false" id="dorpdown66">
                                        <svg class="feather">
                                            <use
                                                href="<?php echo e(asset('assets/svg/feather-icons/dist/feather-sprite.svg#more-horizontal')); ?>">
                                            </use>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dorpdown66"><a
                                            class="dropdown-item" href="#">Weekly</a><a class="dropdown-item"
                                                                                        href="#">Monthly</a><a class="dropdown-item" href="#">Yearly</a>
                                    </div>
                                </div>
                            ...
                            <li class="d-flex line-primary">
                                ...
                                <div class="dropdown task-dropdown">
                                    <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                            aria-expanded="false" id="dorpdown77">
                                        <svg class="feather">
                                            <use
                                                href="<?php echo e(asset('assets/svg/feather-icons/dist/feather-sprite.svg#more-horizontal')); ?>">
                                            </use>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dorpdown77"><a
                                            class="dropdown-item" href="#">Weekly</a><a class="dropdown-item"
                                                                                        href="#">Monthly</a><a class="dropdown-item" href="#">Yearly</a>
                                    </div>
                                </div>
                            ...
                            <li class="d-flex line-secondary">
                                ...
                                <div class="dropdown task-dropdown">
                                    <button class="btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
                                            aria-expanded="false" id="dropdown88">
                                        <svg class="feather">
                                            <use
                                                href="<?php echo e(asset('assets/svg/feather-icons/dist/feather-sprite.svg#more-horizontal')); ?>">
                                            </use>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown88"><a
                                            class="dropdown-item" href="#">Weekly</a><a class="dropdown-item"
                                                                                        href="#">Monthly</a><a class="dropdown-item" href="#">Yearly</a>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="project-cost">
                                    <h5 class="font-light">
                                        <svg class="svg-w-20 stroke-light me-2">
                                            <use href="<?php echo e(asset('assets/svg/iconly-sprite.svg#Chart')); ?>">
                                            </use>
                                            ...
                                            <div class="d-flex bg-light-primary flex-column">
                                                <div class="flex-shrink-0 border-primary">
                                                    <svg class="svg-w-24 stroke-primary">
                                                        <use href="<?php echo e(asset('assets/svg/iconly-sprite.svg#Pie')); ?>">
                                                        </use>
                                                    </svg>
                                                </div>
                                            ...
                                            <div class="d-flex bg-light-secondary flex-column">
                                                <div class="flex-shrink-0 border-secondary">
                                                    <svg class="svg-w-24 stroke-secondary">
                                                        <use href="<?php echo e(asset('assets/svg/iconly-sprite.svg#Category')); ?>">
                                                        </use>
                                                    </svg>
                                                </div>
                                                <div class="flex-grow-1">
                                            ...
                                            <div class="d-flex bg-light-tertiary flex-column">
                                                <div class="flex-shrink-0 border-tertiary">
                                                    <svg class="svg-w-24 stroke-tertiary">
                                                        <use href="<?php echo e(asset('assets/svg/iconly-sprite.svg#Document')); ?>">
                                                        </use>
                                                    </svg>
                                                </div>
                                                <div class="flex-grow-1">
                                    ...
                                    <div class="task-bottom d-flex align-items-center gap-2">
                                        ...
                                        <h2 class="font-primary">83%</h2><span class="badge bg-light f-14">
                                            <svg class="svg-w-20 stroke-dark me-1">
                                                <use href="<?php echo e(asset('assets/svg/iconly-sprite.svg#right-3')); ?>">
                                                </use>
                                            </svg>3.4%</span>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4 custom-width-2">
                                <h5 class="font-light">
                                    <svg class="svg-w-20 stroke-light me-2">
                                        <use href="<?php echo e(asset('assets/svg/iconly-sprite.svg#User')); ?>">
                                        </use>
                                    </svg>Our crew
                                </h5>
                                    ...
                                    <div class="customers d-inline-block avatar-group">
                                        <ul>
                                            <li class="d-inline-block"><img class="img-40 b-r-8"
                                                                            src="<?php echo e(asset('assets/images/user/13.jpg')); ?>" alt="#"></li>
                                            <li class="d-inline-block"><img class="img-40 b-r-8"
                                                                            src="<?php echo e(asset('assets/images/user/6.jpg')); ?>" alt="#"></li>
                                            <li class="d-inline-block"><img class="img-40 b-r-8"
                                                                            src="<?php echo e(asset('assets/images/user/3.jpg')); ?>" alt="#"></li>
                            ...
                            <table class="table">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="<?php echo e(asset('assets/images/dashboard1/invest/01.jpg')); ?>"
                                                    alt="">
                                            </div>
                                            <div class="flex-grow-1"> <a href="<?php echo e(route('admin.user_profile')); ?>">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="<?php echo e(asset('assets/images/dashboard1/invest/02.jpg')); ?>"
                                                    alt="">
                                            </div>
                                            <div class="flex-grow-1"> <a href="<?php echo e(route('admin.user_profile')); ?>">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="<?php echo e(asset('assets/images/dashboard1/invest/03.jpg')); ?>"
                                                    alt="">
                                            </div>
                                            <div class="flex-grow-1"> <a href="<?php echo e(route('admin.user_profile')); ?>">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="flex-shrink-0"><img
                                                    src="<?php echo e(asset('assets/images/dashboard1/invest/04.jpg')); ?>"
                                                    alt="">
                                            </div>
                                            <div class="flex-grow-1"> <a href="<?php echo e(route('admin.user_profile')); ?>">
                                ...
                                <ul class="activity-update">
                                    <li class="d-flex align-items-center b-l-primary">
                                        ...
                                        <div class="flex-shrink-0"> <img class="img-40 b-r-10"
                                                                         src="<?php echo e(asset('assets/images/avatar/11.jpg')); ?>" alt=""></div>
                                    </li>
                                    <li class="d-flex align-items-center b-l-secondary">
                                        ...
                                        <div class="flex-shrink-0"> <img class="img-40 b-r-10"
                                                                         src="<?php echo e(asset('assets/images/avatar/1.jpg')); ?>" alt=""></div>
                                    </li>
                                    <li class="d-flex align-items-center b-l-tertiary">
                                        ...
                                        <div class="flex-shrink-0"> <img class="img-40 b-r-10"
                                                                         src="<?php echo e(asset('assets/images/avatar/3.jpg')); ?>" alt=""></div>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-pane fade" id="tue" role="tabpanel" aria-labelledby="tue-tab">
                                <ul class="activity-update">
                                    <li class="d-flex align-items-center b-l-info">
                                        ...
                                        <div class="flex-shrink-0"> <img class="img-40 b-r-10"
                                                                         src="<?php echo e(asset('assets/images/avatar/2.jpg')); ?>" alt=""></div>
                                    </li>
                                    <li class="d-flex align-items-center b-l-success">
                                        ...
                                        <div class="flex-shrink-0"> <img class="img-40 b-r-10"
                                                                         src="<?php echo e(asset('assets/images/avatar/4.jpg')); ?>" alt=""></div>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-pane fade" id="wed" role="tabpanel" aria-labelledby="wed-tab">
                                <ul class="activity-update">
                                    <li class="d-flex align-items-center b-l-danger">
                                        ...
                                        <div class="flex-shrink-0"> <img class="img-40 b-r-10"
                                                                         src="<?php echo e(asset('assets/images/avatar/5.jpg')); ?>" alt=""></div>
                                    </li>
                                    <li class="d-flex align-items-center b-l-dark">
                                        ...
                                        <div class="flex-shrink-0"> <img class="img-40 b-r-10"
                                                                         src="<?php echo e(asset('assets/images/avatar/6.jpg')); ?>" alt=""></div>
                                    </li>
                                    <li class="d-flex align-items-center b-l-warning">
                                        ...
                                        <div class="flex-shrink-0"> <img class="img-40 b-r-10"
                                                                         src="<?php echo e(asset('assets/images/avatar/9.jpg')); ?>" alt=""></div>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="d-flex justify-content-xl-between justify-content-evenly">
                                    <li>
                                        <div class="badge bg-light-primary b-r-0">
                                            <svg class="svg-menu me-1">
                                                <use href="<?php echo e(asset('assets/svg/iconly-sprite.svg#mobile')); ?>">
                                                </use>
                                            </svg>Mobile
                                        </div>
                                    ...
                                    <li>
                                        <div class="badge bg-light-secondary b-r-0">
                                            <svg class="svg-menu me-1">
                                                <use href="<?php echo e(asset('assets/svg/iconly-sprite.svg#desktop')); ?>">
                                                </use>
                                            </svg>Desktop
                                        </div>
                                        <div class="d-block text-center mt-2">
                    ...
                    <div class="card-body p-0">
                        <div class="d-flex bg-light gap-3">
                            <div class="flex-shrink-0"> <img class="img-40 b-r-15"
                                                             src="<?php echo e(asset('assets/images/avatar/10.jpg')); ?>" alt="Use1">
                            </div>
                            <div class="flex-grow-1"><a href="<?php echo e(route('admin.user_profile')); ?>">
                        ...
                        <div class="d-flex gap-3">
                            <div class="flex-shrink-0"> <img class="img-40 b-r-15"
                                                             src="<?php echo e(asset('assets/images/avatar/4.jpg')); ?>" alt="Use2">
                            </div>
                            <div class="flex-grow-1"><a href="<?php echo e(route('admin.user_profile')); ?>">
                        ...
                        <div class="d-flex gap-3">
                            <div class="flex-shrink-0"> <img class="img-40 b-r-15"
                                                             src="<?php echo e(asset('assets/images/avatar/12.jpg')); ?>" alt="Use3">
                            </div>
                            <div class="flex-grow-1"><a href="<?php echo e(route('admin.user_profile')); ?>">
...
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(asset('assets/js/vendors/apexcharts/dist/apexcharts.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/vendors/chart.js/dist/chart.umd.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/vendors/simple-datatables/dist/umd/simple-datatables.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/dashboard/default.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Kisan\resources\views/home.blade.php ENDPATH**/ ?>