            ...
            <div class="col-sm-6">
                <nav>
                    <ol class="breadcrumb justify-content-sm-end align-items-center">
                        ...
                        <li class="breadcrumb-item">Ucs</li>
                ...
                <div class="card user-role">
                    <div class="card-body border-b-primary border-2">
                        <div class="upcoming-box">
                            ...
                            <p>Add Uc</p>
                            <a href="<?php echo e(route('admin.uc.create')); ?>" class="btn btn-primary"><?php echo e(__('Add Uc')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Kisan\resources\views/admin/ucs/index.blade.php ENDPATH**/ ?>