                            ...
                            <div class="col-12">
                                <div class="total-num counter">
                                    <div class="d-flex by-role custom-scrollbar">
                                        ...
                                        <div class="total-user bg-light-primary">
                                            <h5> Districts </h5>
                                            <span class="total-num counter"><?php echo e($district); ?></span>
                                        </div>
                                        <div class="total-user bg-light-primary">
                                            <h5> Ucs </h5>
                ...
                <div class="card user-role">
                    <div class="card-body border-b-primary border-2">
                        <div class="upcoming-box">
                            ...
                            <p>Add Tehsil</p>
                            <a href="<?php echo e(route('admin.tehsil.create')); ?>" class="btn btn-primary"><?php echo e(__('Add Tehsil')); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Kisan\resources\views/admin/tehsils/index.blade.php ENDPATH**/ ?>