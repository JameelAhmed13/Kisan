...
class UserController extends Controller
{
    ...
    {
        $roles = Role::count('roleID');
        $allRoles = Role::all();
        return $dataTable->render('admin.user.index', compact('roles', 'allRoles'));
    }
    ...
    {
        return view('admin.user.create', ['user' => $user,'roles' => $this->role->get()]);
    }
    ...
    {
        return $this->repository->update($request, $user->userID);
    }
    ...
    {
        return $this->repository->destroy($user->userID);
    }
    ...
    {
        return view('admin.user_profile.edit_profile',['user' => Auth::user(),'role' => Auth::user()->roles[0]->roleName]);
    }
