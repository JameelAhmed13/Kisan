(function ($) {
    ...
    var optionscolumnchart = {
      ...
      colors: [EdminAdminConfig.secondary, EdminAdminConfig.tertiary, EdminAdminConfig.primary],
      fill: {
        type: "gradient",
        gradient: {
          shade: "light",
        ...
        yaxis: [
          {
            y: 8200,
            y2: 8400,
            borderColor: EdminAdminConfig.success,
            fillColor: EdminAdminConfig.success,
            opacity: 0.1,
            label: {
              borderColor: EdminAdminConfig.success,
              offsetX: -30,
              style: {
                fontSize: "10px",
                color: "#fff",
                background: EdminAdminConfig.success,
              },
              text: "Y-axis range",
            },
          },
        ...
        xaxis: [
          {
            ...
            label: {
              ...
              style: {
                color: "#fff",
                background: EdminAdminConfig.primary,
              },
              text: "Anno Test",
            },
          },
          {
            ...
            fillColor: EdminAdminConfig.tertiary,
            opacity: 0.1,
            label: {
              ...
              style: {
                fontSize: "10px",
                color: "#fff",
                background: EdminAdminConfig.tertiary,
              },
              offsetY: 20,
              text: "X-axis range",
            },
    ...
    var optionscandlestickchart = {
      ...
      plotOptions: {
        candlestick: {
          colors: {
            upward: EdminAdminConfig.secondary,
            downward: EdminAdminConfig.primary,
          },
        },
      },
      legend: {
    ...
    var optionsCircle = {
      ...
      colors: [EdminAdminConfig.secondary, EdminAdminConfig.primary, EdminAdminConfig.tertiary],
      responsive: [
        {
          breakpoint: 767,
          options: {
    ...
    var optionsProgress1 = {
      ...
      plotOptions: {
        bar: {
          ...
          barHeight: "15%",
          colors: {
            backgroundBarColors: [EdminAdminConfig.primary],
      ...
      fill: {
        ...
        type: "gradient",
        gradient: {
          gradientToColors: [EdminAdminConfig.primary],
        },
      },
      series: [
        {
    ...
    var optionsProgress2 = {
      ...
      plotOptions: {
        bar: {
          ...
          barHeight: "15%",
          colors: {
            backgroundBarColors: [EdminAdminConfig.secondary],
            backgroundBarOpacity: 0.2,
    ...
    var optionsProgress3 = {
      ...
      plotOptions: {
        bar: {
          ...
          barHeight: "15%",
          colors: {
            backgroundBarColors: [EdminAdminConfig.tertiary],
            backgroundBarOpacity: 0.2,
            backgroundBarRadius: 10,
          },
        },
      ...
      fill: {
        ...
        type: "gradient",
        gradient: {
          gradientToColors: [EdminAdminConfig.tertiary],
        },
      },
      title: {
        floating: true,
    ...
    var optionsProgress4 = {
      ...
      plotOptions: {
        bar: {
          ...
          barHeight: "15%",
          colors: {
            backgroundBarColors: ["EdminAdminConfig.success"],
            backgroundBarOpacity: 0.2,
            backgroundBarRadius: 10,
          },
        },
      },
      colors: ["EdminAdminConfig.success"],
      stroke: {
        width: 0,
      },
      series: [
      ...
      fill: {
        ...
        type: "gradient",
        gradient: {
          gradientToColors: [EdminAdminConfig.success],
        },
      },
      title: {
        floating: true,
    ...
    var optionsProgress5 = {
      ...
      plotOptions: {
        bar: {
          ...
          barHeight: "15%",
          colors: {
            backgroundBarColors: [EdminAdminConfig.info],
            backgroundBarOpacity: 0.2,
            backgroundBarRadius: 10,
          },
        },
      },
      colors: [EdminAdminConfig.info],
      stroke: {
        width: 0,
      },
      series: [
      ...
      fill: {
        ...
        type: "gradient",
        gradient: {
          gradientToColors: [EdminAdminConfig.info],
        },
      },
      title: {
        floating: true,
