...
@section('main_content')
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                        <h4>Whether Icons With Animations</h4>
                    </div>
                    <div class="card-body">
                        <div class="row icon-lists icon-event whether-icon">
                                        ...
                                        <g class="climacon_iconWrap climacon_iconWrap-sun">
                                            <g class="climacon_componentWrap climacon_componentWrap-sun">
                                                ...
                                                <g class="climacon_componentWrap climacon_componentWrap_sunBody"
                                                    clip-path="url(#sunFillClip)">
                                                    <circle
                                                        class="climacon_component climacon_component-stroke climacon_component-stroke_sunBody"
                                                        cx="50.034" cy="50" r="11.999"></circle>
                                                </g>
                                            </g>
                                        </g>
                                    </svg>
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_sunFill" id="sunFill" version="1.1"
                                        viewBox="15 15 70 70">
                                            ...
                                            <g class="climacon_componentWrap climacon_componentWrap-sun">
                                                ...
                                                <g class="climacon_componentWrap climacon_componentWrap_sunBody">
                                                    ...
                                                    <circle
                                                        ...
                                                        fill="#FFFFFF" cx="50.034" cy="50" r="7.999"></circle>
                                                </g>
                                            </g>
                                        </g>
                                    </svg>
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_moonFill" id="moonfill" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_snowflake" id="sunsetAlt" version="1.1"
                                        viewBox="15 15 70 70">
                                        ...
                                        <g class="climacon_iconWrap climacon_iconWrap-snowflake">
                                            <g class="climacon_componentWrap climacon_componentWrap-snowflake"
                                                clip-path="url(#snowflakeFillClip)">
                                                <path
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_snowflakeFill" id="snowflakeFill" version="1.1"
                                        viewBox="15 15 70 70">
                                        <g class="climacon_iconWrap climacon_iconWrap-snowflakeFill">
                                            <g class="climacon_componentWrap climacon_componentWrap-snowflake">
                                                ...
                                                <circle
                                                    ...
                                                    fill="#FFFFFF" cx="50" cy="50" r="4"></circle>
                                            </g>
                                        </g>
                                    </svg>
                                </div>
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_wind" id="wind" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_tornado" id="tornado" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloud" id="cloud" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudFill" id="cloudFill" version="1.1"
                                        viewBox="15 15 70 70">
                                        <g class="climacon_iconWrap climacon_iconWrap-cloud">
                                            <g class="climacon_componentWrap climacon_componentWrap_cloud">
                                                <path
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSun" id="cloudSun" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSunFill" id="cloudSunFill" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudMoon" id="cloudMoon" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudMoonFill" id="cloudMoonFill" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudDrizzleFill" id="cloudDrizzleFill" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudDrizzleSun" id="cloudDrizzleSun" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudDrizzleSunFill" id="cloudDrizzleSunFill"
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudDrizzleMoon" id="cloudDrizzleMoon" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudDrizzleMoonFill" id="cloudDrizzleMoonFill"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudDrizzleAlt" id="cloudDrizzleAlt" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudDrizzleFillAlt" id="cloudDrizzleAltfill1"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudDrizzleSunAlt" id="cloudDrizzleSunAlt"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudDrizzleSunFillAlt" id="cloudDrizzleSunFillAlt"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudDrizzleMoonAlt" id="cloudDrizzleMoonAlt"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudRain" id="cloudRain" version="1.1"
                                        viewBox="15 15 70 70">
                                        ...
                                        <g class="climacon_iconWrap climacon_iconWrap-cloudRain">
                                            ...
                                            <g class="climacon_wrapperComponent climacon_wrapperComponent_cloud"
                                                clip-path="url(#cloudFillClip)">
                                                <path
                                                    class="climacon_component climacon_component-stroke climacon_component-stroke_cloud"
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudRainFill" id="cloudRainFill" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudRainSun" id="cloudRainSun" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudRainSunFill" id="cloudRainSunFill" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudRainMoon" id="cloudRainMoon" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudRainMoonFill" id="cloudRainMoonFill"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudRainAlt" id="cloudRainAlt" version="1.1"
                                        viewBox="15 15 70 70">
                                        ...
                                        <g class="climacon_iconWrap climacon_iconWrap-cloudRainAlt">
                                            <g
                                                class="climacon_wrapperComponent climacon_wrapperComponent-rain climacon_wrapperComponent-rain_alt">
                                                <path
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudRainAltFill" id="cloudRainAltFill" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSunRainAlt" id="cloudRainSunAlt" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSunRainAltFill" id="cloudRainSunAltFill"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudMoonRainAlt" id="cloudRainMoonAlt" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudMoonRainAltFill" id="cloudRainMoonAltFill"
                                        version="1.1" viewBox="15 15 70 70">
                                        <g class="climacon_iconWrap climacon_iconWrap-cloudRainSunAlt">
                                            <g
                                                class="climacon_wrapperComponent climacon_wrapperComponent-moon climacon_componentWrap-moon_cloud">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudHailAlt" id="cloudHailAlt" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudHailAltFill" id="cloudHailAltFill" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudHailAltSun" id="cloudHailAltSun" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudHailAltMoon" id="cloudHailAltMoon" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudHailAltMoonFill" id="cloudHailAltMoonFill"
                                        version="1.1" viewBox="15 15 70 70">
                                        <g class="climacon_iconWrap climacon_iconWrap-cloudHailAltMoon">
                                            <g
                                                class="climacon_wrapperComponent climacon_wrapperComponent-moon climacon_componentWrap-moon_cloud">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSnow" id="cloudSnow" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSnowFill" id="cloudSnowFill" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSnowSun" id="cloudSnowSun" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSnowSunFill" id="cloudSnowSunFill"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSnowMoon" id="cloudSnowMoon" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSnowMoonFill" id="cloudSnowMoonFill"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSnowAlt" id="cloudSnowAltfill2" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSnowAltFill" id="cloudSnowAltFill"
                                        version="1.1" viewBox="15 15 70 70">
                                        <g class="climacon_iconWrap climacon_iconWrap-cloudSnowAltFill">
                                            <g class="climacon_wrapperComponent climacon_wrapperComponent-snowAlt">
                                                <g
                                                    class="climacon_component climacon_component climacon_component-snowAlt">
                                                    <path
                                                        class="climacon_component climacon_component-stroke climacon_component-stroke_snowAlt"
                                                        d="M43.072,59.641c0.553-0.957,1.775-1.283,2.732-0.731L48,60.176v-2.535c0-1.104,0.896-2,2-2c1.104,0,2,0.896,2,2v2.535l2.195-1.268c0.957-0.551,2.18-0.225,2.73,0.732c0.553,0.957,0.225,2.18-0.73,2.731l-2.196,1.269l2.196,1.268c0.955,0.553,1.283,1.775,0.73,2.732c-0.552,0.954-1.773,1.282-2.73,0.729L52,67.104v2.535c0,1.105-0.896,2-2,2c-1.104,0-2-0.895-2-2v-2.535l-2.195,1.269c-0.957,0.553-2.18,0.226-2.732-0.729c-0.552-0.957-0.225-2.181,0.732-2.732L46,63.641l-2.195-1.268C42.848,61.82,42.521,60.598,43.072,59.641z">
                                                    </path>
                                                    <circle
                                                        ...
                                                        fill="#FFFFFF" cx="50" cy="63.641" r="2"></circle>
                                                </g>
                                            </g>
                                            <g class="climacon_componentWrap climacon_componentWrap_cloud">
                                                <path
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSnowSunAlt" id="cloudSnowSunAlt" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSnowSunAltFill" id="cloudSnowSunAltFill"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSnowAlt" id="cloudSnowAlt" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudSnowAltFill" id="cloudSnowAltFill1"
                                        version="1.1" viewBox="15 15 70 70">
                                        <g class="climacon_iconWrap climacon_iconWrap-cloudSnowAltFill">
                                            <g
                                                class="climacon_wrapperComponent climacon_wrapperComponent-moon climacon_componentWrap-moon_cloud">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudFog" id="cloudFog" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudFogFill" id="cloudFogFill" version="1.1"
                                        viewBox="15 15 70 70">
                                        <g class="climacon_iconWrap climacon_iconWrap-cloudFog">
                                            <g class="climacon_wrapperComponent climacon_wrapperComponent-Fog">
                                                <path
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudFogSun" id="cloudFogSun" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudFogSunFill" id="cloudFogSunFill" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudFogMoon" id="cloudFogMoon" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudFogMoonFill" id="cloudFogMoonFill"
                                        version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudFogAlt" id="cloudFogAlt" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudFogAltFill" id="cloudFogAltFill" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudFogSunAlt" id="cloudFogSunAlt" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudFogSunAltFill" id="cloudFogSunAltFill"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudFogMoonAlt" id="cloudFogMoonAlt" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudFogMoonAltFill" id="cloudFogMoonAltFill"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudLightning" id="cloudLightningfill2"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudLightningFill" id="cloudLightningFill"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudLightningSun" id="cloudLightningfill1"
                                        version="1.1" viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_cloudLightningSunFill" id="cloudLightningSunFill"
                                        version="1.1" viewBox="15 15 70 70">
                                        <g class="climacon_iconWrap climacon_iconWrap-cloudLightning">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_sunrise" id="sunrise" version="1.1"
                                        viewBox="15 15 70 70">
                                        <g class="climacon_iconWrap climacon_iconWrap-sunrise">
                                            <g class="climacon_componentWrap climacon_componentWrap-sunrise">
                                                ...
                                                <g
                                                    class="climacon_wrapperComponent climacon_wrapperComponent-horizonLine">
                                                    <path
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_sunriseFill" id="sunriseFill" version="1.1"
                                        viewBox="15 15 70 70">
                                        <g class="climacon_iconWrap climacon_iconWrap-sunriseFill">
                                            <g class="climacon_componentWrap climacon_componentWrap-sunrise">
                                                ...
                                                <g class="climacon_wrapperComponent climacon_wrapperComponent-sunBody">
                                                    <circle
                                                        class="climacon_component climacon_component-stroke climacon_component-stroke_sunBody"
                                                        cx="50.001" cy="56" r="11.999"></circle>
                                                    <circle
                                                        class="climacon_component climacon_component-fill climacon_component-fill_sunBody"
                                                        fill="#FFFFFF" cx="50.001" cy="56" r="7.999">
                                                    </circle>
                                                </g>
                                                <g class="climacon_wrapperComponent climacon_wrapperComponent-arrow">
                                                    <path
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_sunset" id="sunset" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_sunsetFill" id="sunsetFill" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_sunriseAlt" id="sunriseAlt" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_sunriseAltFill" id="sunriseAltFill" version="1.1"
                                        viewBox="15 15 70 70">
                                            ...
                                            <g clip-path="url(#sunriseFillClip)">
                                                <g class="climacon_componentWrap climacon_componentWrap-sunriseAlt">
                                                    ...
                                                    <g
                                                        ...
                                                        <circle
                                                            class="climacon_component climacon_component-stroke climacon_component-stroke_sunBody"
                                                            cx="50.313" cy="76" r="11.999"></circle>
                                                        <circle
                                                            class="climacon_component climacon_component-fill climacon_component-fill_sunBody"
                                                            fill="#FFFFFF" cx="50.001" cy="76" r="7.999">
                                                        </circle>
                                                    </g>
                                                </g>
                                            </g>
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_sunsetAlt" id="sunsetAltfill" version="1.1"
                                        viewBox="15 15 70 70">
                            ...
                            <div class="col-xxl-2 col-lg-3 col-sm-4">
                                <div class="card d-flex align-items-center flex-column default-border">
                                    <svg class="climacon climacon_sunsetAltFill" id="sunsetAltFill" version="1.1"
                                        viewBox="15 15 70 70">
                                        ...
                                        <g class="climacon_iconWrap climacon_iconWrap-sunsetAltFill">
                                            <g clip-path="url(#sunriseFillClip)">
                                                <g
                                                    class="climacon_componentWrap climacon_componentWrap-sunset climacon_componentWrap-sunsetAlt">
                                                    <g class="climacon_componentWrap climacon_componentWrap-sunSpoke">
                                                        <path
                                                            class="climacon_component climacon_component-stroke climacon_component-stroke_sunSpoke climacon_component-stroke_sunSpoke-east"
                                                            d="M72.31,77.999h-3.998c-1.104,0-2-0.896-2-1.999s0.896-2,2-2h3.998c1.104,0,2,0.896,2,2S73.416,77.999,72.31,77.999z">
    ...
    <div class="icon-hover-bottom position-fixed icons-show-div">
        <div class="container-fluid">
          <div class="row">
