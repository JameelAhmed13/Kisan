                            ...
                            <div class="card-body">
                              <div class="email-app-sidebar left-bookmark">
                                ...
                                <ul class="nav main-menu" role="tablist">
                                  <li class="nav-item">
                                    <button class="btn-light-primary btn-block btn-mail w-100" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                  ...
                                  <li><a id="pills-favourites-tab" data-bs-toggle="pill" href="#pills-favourites" role="tab" aria-controls="pills-favourites" aria-selected="false"><span class="title"> Favourites</span></a></li>
                                  <li><a id="pills-shared-tab" data-bs-toggle="pill" href="#pills-shared" role="tab" aria-controls="pills-shared" aria-selected="false"><span class="title"> Shared with me</span></a></li>
                                  <li><a id="pills-bookmark-tab" data-bs-toggle="pill" href="#pills-bookmark" role="tab" aria-controls="pills-bookmark" aria-selected="false"><span class="title"> My bookmark</span></a></li>
                                  <li>
                                    <hr>
                                  </li>
                                  <li><span class="main-title"> Tags<span class="pull-right"><a href="#" data-bs-toggle="modal" data-bs-target="#createtag">
                                          <svg class="feather stroke-primary">
                                            <use href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#plus-circle') }}"></use>
                                          </svg></a></span></span></li>
                                  <li><a id="pills-notification-tab" data-bs-toggle="pill" href="#pills-notification" role="tab" aria-controls="pills-notification" aria-selected="false"><span class="title"> notification</span></a></li>
                                  <li><a id="pills-newsletter-tab" data-bs-toggle="pill" href="#pills-newsletter" role="tab" aria-controls="pills-newsletter" aria-selected="false"><span class="title"> Newsletter</span></a></li>
                                  <li><a id="pills-business-tab" data-bs-toggle="pill" href="#pills-business" role="tab" aria-controls="pills-business-tab" aria-selected="false"><span class="title"> Business</span></a></li>
                                  <li><a id="pills-holidays-tab" data-bs-toggle="pill" href="#pills-holidays" role="tab" aria-controls="pills-holidays-tab" aria-selected="false"><span class="title"> Holidays</span></a></li>
                                  <li><a id="pills-important-tab" data-bs-toggle="pill" href="#pills-important" role="tab" aria-controls="pills-important-tab" aria-selected="false"><span class="title"> Important</span></a></li>
                                  <li><a id="pills-orgenization-tab" data-bs-toggle="pill" href="#pills-orgenization" role="tab" aria-controls="pills-orgenization-tab" aria-selected="false"><span class="title"> Organization</span></a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
                                    ...
                                    <div class="row" id="bookmarkData">
                                      <div class="col-xxl-3 col-md-4 col-ed-4">
                                        <div class="card card-with-border bookmark-card o-hidden">
                                          <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallery/1.jpg') }}" alt="">
                                            ...
                                            <div class="desciption-data">
                                              <div class="title-bookmark">
                                                ...
                                                <p class="weburl_0">http://admin.pixelstrap.com//ltr/landing-page.html</p>
                                                <div class="hover-block">
                                                  <ul>
                                                    <li><a href="" onclick="editBookmark(0)" data-bs-toggle="modal" data-bs-target="#edit-bookmark">
                                                        <svg class="feather">
                                                    ...
                                                    <li class="pull-right text-end"><a href="javascript:void(0)">
                                                        <svg class="feather">
                                      ...
                                      <div class="col-xxl-3 col-md-4 col-ed-4">
                                        <div class="card card-with-border bookmark-card o-hidden">
                                          <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallery/2.jpg') }}" alt="">
                                            ...
                                            <div class="desciption-data">
                                              <div class="title-bookmark">
                                                ...
                                                <div class="hover-block">
                                                  <ul>
                                                    <li><a href="" onclick="editBookmark(1)" data-bs-toggle="modal" data-bs-target="#edit-bookmark">
                                                        <svg class="feather">
                                                          <use href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#edit-2') }}"></use>
                                                        </svg></a></li>
                                                    <li><a href="javascript:void(0)">
                                      ...
                                      <div class="col-xxl-3 col-md-4 col-ed-4">
                                        <div class="card card-with-border bookmark-card o-hidden">
                                          <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallery/3.jpg') }}" alt="">
                                            ...
                                            <div class="desciption-data">
                                              <div class="title-bookmark">
                                                ...
                                                <p class="weburl_2">https://angular.pixelstrap.com/Edmin/landing</p>
                                                <div class="hover-block">
                                                  <ul>
                                                    <li><a href="" onclick="editBookmark(2)" data-bs-toggle="modal" data-bs-target="#edit-bookmark">
                                                        <svg class="feather">
                                                          <use href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#edit-2') }}"></use>
                                                        </svg></a></li>
                                                    <li><a href="javascript:void(0)">
                                                ...
                                                <div class="content-general">
                                                  <p class="desc_2">Edmin is beautifully crafted, clean and modern designed admin theme</p><span class="collection_2">Fs</span>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                                      ...
                                      <div class="col-xxl-3 col-md-4 col-ed-4">
                                        <div class="card card-with-border bookmark-card o-hidden">
                                          <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallery/4.jpg') }}" alt="">
                                            ...
                                            <div class="desciption-data">
                                              <div class="title-bookmark">
                                                ...
                                                <div class="hover-block">
                                                  <ul>
                                                    <li><a href="" onclick="editBookmark(3)" data-bs-toggle="modal" data-bs-target="#edit-bookmark">
                                                        <svg class="feather">
                                                          <use href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#edit-2') }}"></use>
                                                        </svg></a></li>
                                                    <li><a href="javascript:void(0)">
                                      ...
                                      <div class="col-xxl-3 col-md-4 col-ed-4">
                                        <div class="card card-with-border bookmark-card o-hidden">
                                          <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallery/5.jpg') }}" alt="">
                                            ...
                                            <div class="desciption-data">
                                              <div class="title-bookmark">
                                                ...
                                                <div class="hover-block">
                                                  <ul>
                                                    <li><a href="" onclick="editBookmark(4)" data-bs-toggle="modal" data-bs-target="#edit-bookmark">
                                                        <svg class="feather">
                                                          <use href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#edit-2') }}"></use>
                                                        </svg></a></li>
                                                    <li><a href="javascript:void(0)">
                                      ...
                                      <div class="col-xxl-3 col-md-4 col-ed-4">
                                        <div class="card card-with-border bookmark-card o-hidden">
                                          <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallery/6.jpg') }}" alt="">
                                            ...
                                            <div class="desciption-data">
                                              <div class="title-bookmark">
                                                ...
                                                <div class="hover-block">
                                                  <ul>
                                                    <li><a href="" onclick="editBookmark(5)" data-bs-toggle="modal" data-bs-target="#edit-bookmark">
                                                        <svg class="feather">
                                                          <use href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#edit-2') }}"></use>
                                                        </svg></a></li>
                                                    <li><a href="javascript:void(0)">
                                ...
                                <div class="card-body">
                                  <div class="details-bookmark text-center">
                                    <div class="row" id="bookmarkData1">
                                      <div class="col-xxl-3 col-md-4 col-ed-4">
                                        <div class="card card-with-border bookmark-card o-hidden">
                                          <div class="details-website"><img class="img-fluid" src="{{ asset('assets/images/lightgallery/7.jpg') }}" alt="">
                                            <div class="favourite-icon favourite_0" onclick="setFavourite(0)"><a href="javascript:void(0)"><i class="fa fa-star"></i></a></div>
                                            <div class="desciption-data">
                                              <div class="title-bookmark">
                                                <h6 class="title_0">Admin Template</h6>
                                                <p class="weburl_0">http://admin.pixelstrap.com/Edmin/ltr/landing-page.html</p>
                                                <div class="hover-block">
                                                  <ul>
                                                    <li><a href="" onclick="editBookmark(0)" data-bs-toggle="modal" data-bs-target="#edit-bookmark">
                                                        <svg class="feather">
                                                ...
                                                <div class="content-general">
                                                  <p class="desc_0">Edmin is beautifully crafted, clean and modern designed admin theme with 6 different demos and light - dark versions.</p><span class="collection_0">General</span>
                                                </div>
                                              </div>
                                            </div>
                                          </div>
                                    ...
                                    <form class="form-bookmark needs-validation" novalidate="">
                                      <div class="row g-2">
                                        <div class="mb-3 mt-0 col-md-12">
                                          <label>Web Url</label>
                                          <input class="form-control" id="editurl" type="text" required="" autocomplete="off" value="http://admin.pixelstrap.com/Edmin/ltr/landing-page.html">
                                        </div>
                                        <div class="mb-3 mt-0 col-md-12">
                                          <label>Title</label>
                                        ...
                                        <div class="mb-3 mt-0 col-md-12">
                                          ...
                                          <textarea class="form-control" id="editdesc" required="" autocomplete="off">Edmin is beautifully crafted, clean and modern designed admin theme with 6 different demos and light - dark versions.</textarea>
                                        </div>
                                    ...
                                    <form class="form-bookmark needs-validation" novalidate="">
                                      <div class="row g-2">
                                        ...
                                        <div class="mb-3 mt-0 col-md-12">
                                          ...
                                          <input class="form-color d-block" type="color" value="#43B9B2">
                                        </div>
                                      </div>
                                      <button class="btn btn-secondary" type="button">Save</button>
                                      <button class="btn btn-primary" type="button" data-bs-dismiss="modal">Cancel</button>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/bookmark/bookmark.js') }}"> </script>
