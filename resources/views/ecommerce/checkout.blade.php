                ...
                <div class="card">
                    ...
                    <div class="card-body checkbox-checked">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-sm-12 checkout">
                                <div class="checkout-details">
                                    <div class="order-box">
                                            ...
                                            <li class="shipping-class">Shipping
                                                <div class="shopping-checkout-option">
                                                    ...
                                                    <label class="d-block" for="chk-ani1">
                                                        <input class="checkbox-primary" id="chk-ani1"
                                                ...
                                                <div class="col">
                                                    ...
                                                    <label class="d-block" for="edo-ani2">
                                                        <input class="radio-primary" id="edo-ani2" type="radio"
                                                            name="rdo-ani" data-original-title=""
                                        ...
                                        <div class="order-place"><a class="btn btn-primary" href="#">Place Order
                                            </a></div>
                                    </div>
                                </div>
                            </div>
