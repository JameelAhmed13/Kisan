            ...
            <div class="col-sm-6">
                <nav>
                    <ol class="breadcrumb justify-content-sm-end align-items-center">
                        ...
                        <li class="breadcrumb-item active">Invoice 6</li>
                    </ol>
                </nav>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="d-flex">
                                                <div class="media-left"><img class="media-object img-60 for-light"
                                                        src="{{ asset('assets/images/logo/logo-login.png') }}" alt=""><img
                                                        class="media-object img-60 for-dark"
                                                        src="{{ asset('assets/images/logo/dark-login-logo.png') }}" alt="">
                                                </div>
                                                <div class="flex-grow-1 m-l-20 text-right">
                                                    <p>hello@Edmin.in<br><span>289-335-6503</span></p>
                                                </div>
                                            </div>
                                            <!-- End Info-->
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="text-md-end text-xs-center">
                                                <h3>Invoice #<span class="counter" id="count1">1069</span></h3>
