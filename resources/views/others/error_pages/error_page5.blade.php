                ...
                <div class="svg-wrraper">
                    <svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 500 500">
                        ...
                        <g id="freepik--Shadow--inject-22">
                            <ellipse class="shp0" id="freepik--path--inject-22" cx="250" cy="416.24"
                        ...
                        <g id="freepik--Error--inject-22">
                            <path class="shp3"
                                d="M299.12,401.62H312.4V405h-8.31v2.55h7.71v3.27h-7.71V414h8.55v3.63H299.12Z"></path>
                            <path class="shp3"
                        ...
                        <g id="freepik--Character--inject-22">
                            ...
                            <ellipse class="shp5" cx="174.74" cy="248.93" rx="3.69" ry="4.77"
                                transform="translate(-80.11 82.95) rotate(-21.86)"></ellipse>
                            <path class="shp5"
                            ...
                            <path class="shp2"
                                d="M164.93,126.23c-8.94.6-16.51,3.6-23.18,10.64a18.31,18.31,0,0,1,17.64,3.65Z"></path>
                            <path class="shp2"
                            ...
                            <path class="shp2"
                                d="M240.34,92.84a26.56,26.56,0,0,1,20.33-2.07,14.65,14.65,0,0,0-10.7,9.68Z"></path>
                            <path class="shp2" d="M241.17,90a21.2,21.2,0,0,1,15.26-5.7,11.69,11.69,0,0,0-6.3,9.63Z">
                            </path>
                            <path class="shp3"
                            ...
                            <circle class="shp2" cx="185.31" cy="156" r="10.83"
                                transform="translate(-31.62 48.22) rotate(-13.67)"></circle>
                            <path class="shp1" d="M176.61,156.65a4.56,4.56,0,1,0,2.39-6A4.56,4.56,0,0,0,176.61,156.65Z">
                            </path>
                            <circle class="shp2" cx="241.1" cy="132.09" r="10.83"
                                transform="translate(28.89 306.87) rotate(-68.19)"></circle>
                            <path class="shp1" d="M232.4,132.74a4.56,4.56,0,1,0,2.39-6A4.55,4.55,0,0,0,232.4,132.74Z">
                            </path>
                            <path class="shp1" d="M186.9,156.67a1.82,1.82,0,1,0,.95-2.4A1.83,1.83,0,0,0,186.9,156.67Z">
                            </path>
                            <path class="shp1" d="M242.69,132.76a1.82,1.82,0,1,0,1-2.39A1.81,1.81,0,0,0,242.69,132.76Z">
                            </path>
                            <path class="shp2"
                            ...
                            <path class="shp3"
                                d="M131.72,180.23c-8.11,3.81-14,11.91-15.47,21.5,7.16-8.74,15.51-6.17,15.51-6.17Z"></path>
                            <path class="shp3"
                                d="M132.55,203.86A21.62,21.62,0,0,0,134,224c-.08-8.6,6.06-11.16,6.06-11.16Z"></path>
                            <path class="shp3"
                                d="M132.08,190.66c-8.17,6.1-12.85,16.47-12.36,27.51,6-11.39,15.9-10.42,15.9-10.42Z"></path>
                            <path class="shp3"
                                d="M296,109.84c8.35-3.24,18.25-1.88,26.24,3.63-11.27-.84-15.17,7-15.17,7Z"></path>
                            <path class="shp3"
                                d="M309.86,126.34c6.73-1.09,14.07-.24,18.57,4.14a23.44,23.44,0,0,0-15.1,5.5Z"></path>
                            <path class="shp3"
                                d="M307.61,125.36c6.11,3,11.57,8,12.67,14.19a23.41,23.41,0,0,0-15.48-4.34Z"></path>
                            <path class="shp3"
                                d="M303.32,117.3c10.05-1.71,20.78,2.06,28.44,10-12.38-3.51-18.51,4.32-18.51,4.32Z"></path>
                            <path class="shp3"
                                d="M190,107.53c-.38-5.66,2.35-10.53,9.11-15.56-1.42,8.08,4.43,10.1,4.43,10.1Z"></path>
                            <path class="shp3"
                                d="M197.38,104.38c1.34-6.58,8.08-13,17.89-17.13-7,7.54-1.36,12.22-1.36,12.22Z"></path>
                            <path class="shp2"
                        ...
                        <g id="freepik--ball-of-yarn--inject-22">
                            <circle class="shp3" cx="202.29" cy="394.69" r="22.97"
                                transform="translate(-224.74 274.91) rotate(-47.2)"></circle>
                            <path class="shp3"
