                                            ...
                                            <tbody>
                                                <tr class="logo-sec"
                                                    ...
                                                    <td><img class="img-fluid for-light"
                                                            src="{{ asset('assets/images/logo/logo-login.png') }}" alt=""></td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="padding: 30px">
                                                        ...
                                                        <div class="text-center"><a href="{{ route('admin.contacts') }}"
                                                                style="padding: 10px; background-color: #43B9B2; color: #fff; display: inline-block; border-radius:30px; margin-bottom:18px; font-weight:600; padding:0.6rem 1.75rem;">Call
                                                                To Action </a></div>
                                                ...
                                                <tr style="text-align: center">
                                                    <td>
                                                        ...
                                                        <p style="color: #999; margin-bottom: 0">Don't Like These Emails?<a
                                                                href="#" style="color: #43B9B2">Unsubscribe</a></p>
                                                        <p style="color: #999; margin-bottom: 0">Powered By Edmin Admin</p>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
