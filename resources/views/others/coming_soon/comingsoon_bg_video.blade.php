...
<div class="container-fluid p-0">
    <div class="comingsoon auth-bg-video">
      ...
      <div class="comingsoon-inner text-center"><img class="img-fluid for-light" src="{{ asset('assets/images/logo/logo-login.png') }}" alt=""><img class="img-fluid for-dark m-auto" src="{{ asset('assets/images/logo/dark-login-logo.png') }}" alt="">
