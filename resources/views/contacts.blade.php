...
@section('main_content')
    ...
    <div class="container-fluid email-wrap bookmark-wrap contact">
        <div class="row">
            <div class="col-xl-3 box-col-6">
                <div class="md-sidebar"><a class="btn btn-primary md-sidebar-toggle" href="javascript:void(0)">contact
                        filter</a>
                                ...
                                <div class="card-body">
                                    <div class="email-app-sidebar left-bookmark">
                                        <div class="d-flex flex-wrap align-items-center">
                                            <div class="media-size-email"><img class="me-2 rounded-circle"
                                                    src="{{ asset('assets/images/user/4.jpg') }}" alt=""></div>
                                            <div class="flex-grow-1">
                                                <h3 class="f-w-600 f-16">MARK JENCO</h3>
                                                <p>Markjecno@gmail.com</p>
                                            </div>
                                        </div>
                                        <ul class="nav main-menu contact-options" role="tablist">
                                            <li class="nav-item">
                                                <button class="badge-light-primary btn-block txt-primary btn-mail w-100"
                                                    type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                    <svg class="feather me-2">
                                                        <use
                                                            href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#users') }}">
                                                        </use>
                                                    </svg> New Contacts
                                                </button>
                                                                ...
                                                                <form class="form-bookmark needs-validation"
                                                                    ...
                                                                    <div class="row g-2">
                                                                        ...
                                                                        <div class="mb-3 col-md-12 mt-0">
                                                                            ...
                                                                            <input class="form-control" id="con-mail"
                                                                                type="text" required=""
                                                                                autocomplete="off">
                                                                        </div>
                                            ...
                                            <li><a id="pills-personal-tab" data-bs-toggle="pill" href="#pills-personal"
                                                    ...
                                                    aria-selected="true"><span class="title"> Personal</span></a></li>
                                            <li>
                                                ...
                                                <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h3 class="modal-title" id="exampleModalLabel1">Add
                                                                    Category</h3>
                                                                <button class="btn-close" type="button"
                                                                    data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                            ...
                                            <li><a class="show" id="pills-organization-tab" data-bs-toggle="pill"
                                                    ...
                                                    aria-controls="pills-organization" aria-selected="false"><span
                                                        class="title"> Organization</span></a></li>
                        ...
                        <div class="ps-0">
                            <div class="tab-content">
                                                ...
                                                <div class="col-xl-4 xl-50 col-md-5">
                                                    <div class="nav flex-column nav-pills" id="v-pills-tab"
                                                        role="tablist" aria-orientation="vertical"><a
                                                            ...
                                                            <div class="d-flex"><img
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <h6> <span class="first_name_0">Bucky </span><span
                                                                            class="last_name_0">Barnes</span></h6>
                                                            ...
                                                            <div class="d-flex"><img
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <h6> <span class="first_name_1">Comeren </span><span
                                                                            class="last_name_1">Diaz</span></h6>
                                                            ...
                                                            <div class="d-flex"><img
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <h6> <span class="first_name_2">Issa </span><span
                                                                            class="last_name_2">Bell</span></h6>
                                                            ...
                                                            href="#v-pills-contact1" role="tab"
                                                            aria-controls="v-pills-settings" aria-selected="false">
                                                            <div class="d-flex"><img
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <h6> <span class="first_name_4">Jason </span><span
                                                                            class="last_name_4">Borne</span></h6>
                                                            ...
                                                            href="#v-pills-contact2" role="tab"
                                                            aria-controls="v-pills-settings" aria-selected="false">
                                                            <div class="d-flex"><img
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <h6> <span class="first_name_5">Monty </span><span
                                                                            class="last_name_5">Carlo</span></h6>
                                                            ...
                                                            href="#v-pills-contact3" role="tab"
                                                            aria-controls="v-pills-settings" aria-selected="false">
                                                            <div class="d-flex"><img
                                                            ...
                                                            <div class="profile-mail">
                                                                ...
                                                                <div class="email-general">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li>Gender <span class="font-primary">Male</span>
                                                                        </li>
                                                                        <li>Birthday<span class="font-primary"> <span
                                                                                    class="font-primary birth_day_0">18</span><span
                                                                                    class="font-primary birth_month_0 ms-1">May</span><span
                                                                                    class="font-primary birth_year_0 ms-1">1994</span></span>
                                                                        </li>
                                                                        <li>Personality<span
                                                                                class="font-primary personality_0">Cool</span>
                                                                        </li>
                                                                        <li>City<span class="font-primary city_0">moline
                                                                                acres</span></li>
                                                                        <li>Mobile No<span
                                                                                class="font-primary mobile_num_0">+0 1800
                                                                                76855</span></li>
                                                            ...
                                                            <div class="profile-mail">
                                                                <div class="d-flex"><img
                                                                    ...
                                                                    <div class="flex-grow-1 mt-0">
                                                                        ...
                                                                        <ul>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="editContact(1)">Edit</a></li>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="deleteContact(1)">Delete</a>
                                                                            </li>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="history(1)">History</a></li>
                                                                            <li><a class="font-primary" href="#"
                                                                ...
                                                                <div class="email-general">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li>Gender <span class="font-primary">Female</span>
                                                                        </li>
                                                                        <li>Birthday<span class="font-primary"> <span
                                                                        ...
                                                                        <li>Mobile No<span
                                                                                class="font-primary mobile_num_1">+0 1800
                                                                                55812</span></li>
                                                                        <li>Email Address <span
                                                            ...
                                                            <div class="profile-mail">
                                                                <div class="d-flex"><img
                                                                    ...
                                                                    <div class="flex-grow-1 mt-0">
                                                                        ...
                                                                        <ul>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="editContact(2)">Edit</a></li>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="deleteContact(2)">Delete</a>
                                                                            </li>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="history(2)">History</a></li>
                                                                            <li><a class="font-primary" href="#"
                                                                ...
                                                                <div class="email-general">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li>Mobile No<span
                                                                                class="font-primary mobile_num_2">+0 1800
                                                                                87412</span></li>
                                                                        <li>Email Address <span
                                                            ...
                                                            <div class="profile-mail">
                                                                <div class="d-flex"><img
                                                                    ...
                                                                    <div class="flex-grow-1 mt-0">
                                                                        ...
                                                                        <ul>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="editContact(3)">Edit</a></li>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="deleteContact(3)">Delete</a>
                                                                            </li>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="history(3)">History</a></li>
                                                                            <li><a class="font-primary" href="#"
                                                                ...
                                                                <div class="email-general">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li>Mobile No<span
                                                                                class="font-primary mobile_num_3">+0 1800
                                                                                79877</span></li>
                                                                        <li>Email Address <span
                                                            ...
                                                            <div class="profile-mail">
                                                                <div class="d-flex"><img
                                                                    ...
                                                                    <div class="flex-grow-1 mt-0">
                                                                        ...
                                                                        <ul>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="editContact(4)">Edit</a></li>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="deleteContact(4)">Delete</a>
                                                                            </li>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="history(4)">History</a></li>
                                                                            <li><a class="font-primary" href="#"
                                                                ...
                                                                <div class="email-general">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li>Mobile No<span
                                                                                class="font-primary mobile_num_4">+0 1800
                                                                                11547</span></li>
                                                                        <li>Email Address <span
                                                            ...
                                                            <div class="profile-mail">
                                                                <div class="d-flex"><img
                                                                    ...
                                                                    <div class="flex-grow-1 mt-0">
                                                                        ...
                                                                        <ul>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="editContact(5)">Edit</a></li>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="deleteContact(5)">Delete</a>
                                                                            </li>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="history(5)">History</a></li>
                                                                            <li><a class="font-primary" href="#"
                                                                ...
                                                                <div class="email-general">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li>Mobile No<span
                                                                                class="font-primary mobile_num_5">+0 1800
                                                                                87944</span></li>
                                                                        <li>Email Address <span
                                                            ...
                                                            <div class="profile-mail">
                                                                <div class="d-flex"><img
                                                                    ...
                                                                    <div class="flex-grow-1 mt-0">
                                                                        ...
                                                                        <ul>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="editContact(6)">Edit</a></li>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="deleteContact(6)">Delete</a>
                                                                            </li>
                                                                            <li><a class="font-primary" href="#"
                                                                                    onclick="history(6)">History</a></li>
                                                                            <li><a class="font-primary" href="#"
                                                                ...
                                                                <div class="email-general">
                                                                    ...
                                                                    <ul>
                                                                        ...
                                                                        <li>Mobile No<span
                                                                                class="font-primary mobile_num_6">+0 1800
                                                                                58712</span></li>
                                                                        <li>Email Address <span
                                                            ...
                                                            <div class="row g-2 more-data">
                                                                <div class="mt-0 mb-3 col-md-12">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-6 col-sm-6">
                                                                            <input class="form-control" id="url_add"
                                                                                type="text" required="">
                                                                        </div>
                                                                ...
                                                                <div class="mt-0 mb-3 col-md-12">
                                                                    ...
                                                                    <div class="d-block">
                                                                        <label class="me-3" for="edo-ani">
                                                                            <input class="form-check-input me-2 radio_animated" id="edo-ani"
                                                                                type="radio" name="rdo-ani"
                                                                                checked=""><span>Male</span>
                                                                        </label>
                                                                        <label for="edo-ani1">
                                                                            <input class="form-check-input me-2 radio_animated" id="edo-ani1"
                                                                                type="radio"
                                                                ...
                                                                <div class="mt-0 mb-3 col-md-12">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-3 col-sm-4">
                                                                            <input class="form-control" id="birth_year"
                                                                                type="text">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="mt-0 mb-3 col-md-12">
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <input class="form-control" id="personality"
                                                                                type="text" required=""
                                                                                autocomplete="off">
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                ...
                                                                more information</a>
                                                            <button class="btn btn-secondary update-contact"
                                                                type="button">Save</button>
                                                            <button class="btn btn-primary" type="button"
                                                                data-bs-dismiss="modal">Cancel</button>
                                                        </form>
                                ...
                                <div class="fade tab-pane" id="pills-organization" role="tabpanel"
                                    ...
                                    <div class="card mb-0">
                                        <div class="card-header d-flex">
                                            <h4>Organization</h4><span class="f-14 pull-right mt-0">10 Contacts</span>
                                        </div>
                                        <div class="card-body p-0">
                                            <div class="row list-persons">
                                                <div class="col-xl-4 xl-50 col-md-5">
                                                    <div class="nav flex-column nav-pills" id="v-pills-tab1"
                                                        role="tablist" aria-orientation="vertical"><a
                                                            class="nav-link active" id="v-pills-iduser-tab"
                                                            data-bs-toggle="pill" href="#v-pills-iduser" role="tab"
                                                            aria-controls="v-pills-iduser" aria-selected="true">
                                                            <div class="d-flex"><img
                                                        ...
                                                        </a><a class="nav-link" id="v-pills-iduser1-tab"
                                                            data-bs-toggle="pill" href="#v-pills-iduser1" role="tab"
                                                            aria-controls="v-pills-iduser1" aria-selected="false">
                                                            <div class="d-flex"><img
                                                                    class="img-50 img-fluid m-r-20 rounded-circle"
                                                        ...
                                                        </a><a class="nav-link" id="v-pills-iduser2-tab"
                                                            data-bs-toggle="pill" href="#v-pills-iduser2" role="tab"
                                                            aria-controls="v-pills-iduser2" aria-selected="false">
                                                            <div class="d-flex"><img
                                                                    class="img-50 img-fluid m-r-20 rounded-circle"
                                                        ...
                                                        </a><a class="nav-link" id="v-pills-iduser3-tab"
                                                            data-bs-toggle="pill" href="#v-pills-iduser3" role="tab"
                                                            aria-controls="v-pills-iduser3" aria-selected="false">
                                                            <div class="d-flex"><img
                                                                    class="img-50 img-fluid m-r-20 rounded-circle"
                                ...
                                <div id="right-history">
                                    <div class="modal-header p-20 border-bottom">
                                    ...
                                    <div class="history-details">
                                        ...
                                        <div class="d-flex"><i class="icofont icofont-star"></i>
                                            <div class="flex-grow-1 mt-0">
                                                ...
                                                <p class="mb-0">Contact is created via mail</p><span class="f-12">Sep
                                                    10, 2019 4:00</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal fade modal-bookmark" id="printModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body list-persons">
                                                <div class="profile-mail pt-0" id="DivIdToPrint">
                                                    <div class="d-flex"><img
                                                            class="img-100 img-fluid m-r-20 rounded-circle" id="updateimg"
                                                            src="{{ asset('assets/images/avatar/5.jpg') }}" alt="">
                                                        <div class="flex-grow-1 mt-0">
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/vendors/sweetalert/dist/sweetalert.min.js') }}"></script>
