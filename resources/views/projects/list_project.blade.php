                ...
                <div class="card">
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="nav nav-tabs border-tab" id="top-tab" role="tablist">
                                <li class="nav-item"><a class="nav-link active" id="top-home-tab" data-bs-toggle="tab"
                                        ...
                                        <svg class="feather">
                                            <use
                                                href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#target') }}">
                                            </use>
                                        </svg>All</a></li>
                                <li class="nav-item"><a class="nav-link" id="profile-top-tab" data-bs-toggle="tab"
                                        ...
                                        <svg class="feather">
                                            <use
                                                href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#info') }}">
                                            </use>
                                        </svg>Doing</a></li>
                        ...
                        <div class="col-md-6 d-md-block d-none">
                            <div class="form-group mb-0 me-0"> </div><a class="btn btn-primary d-flex align-items-center"
                                href="{{ route('admin.project_create') }}">
                                <svg class="feather">
                                    <use href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#plus-square') }}">
                                    </use>
                            ...
                            <div class="tab-pane fade show active" id="top-home" role="tabpanel"
                                ...
                                <div class="row">
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-danger"><span
                                                class="badge badge-danger">Doing</span>
                                            <h5 class="f-w-500 mb-2">Cutting-Edge Design </h5>
                                            <div class="d-flex mb-2 align-items-center"><img
                                                    class="img-20 me-1 rounded-circle"
                                                    src="{{ asset('assets/images/user/4.jpg') }}" alt=""
                                                    data-original-title="" title="">
                                                <p class="font-light">Themeforest, australia</p>
                                            </div>
                                            <p>Responsive Layout: The design is responsive and tablets, and mobile devices
                                            </p>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-success"><span
                                            ...
                                            <p>Consistency and Branding: The design maintains consistency , color scheme,
                                                and typography. </p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-success"><span
                                            ...
                                            <p>Error Handling and Feedback: The design incorporates and feedback mechanisms.
                                            </p>
                                            <div class="row details">
                                                <div class="col-6"> <span>Issues </span></div>
                                                <div class="col-6 font-success">40</div>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-success"><span
                                            ...
                                            <p>Customization Options: Depending on It is designed to be responsive options.
                                            </p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                                <div class="col-6 font-success">24</div>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-danger"><span
                                                class="badge badge-danger">Doing</span>
                                            <h5 class="f-w-500 mb-2 font-danger">Modular Structure</h5>
                                            <div class="d-flex mb-2 align-items-center"><img
                                                    class="img-20 me-1 rounded-circle"
                                                    src="{{ asset('assets/images/user/1.jpg') }}" alt=""
                                                    data-original-title="" title="">
                                            ...
                                            <p>Customization Options: Poco admin offers Attention is given to readability a
                                                visually extensive.</p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                                <div class="col-6 font-danger">12 </div>
                                                <div class="col-6"> <span>Resolved</span></div>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-success"><span
                                                class="badge badge-success">Done</span>
                                            <h5 class="f-w-500 mb-2">Dazzling Admin Design </h5>
                                            <div class="d-flex mb-2 align-items-center"><img
                                                    class="img-20 me-1 rounded-circle"
                                            ...
                                            <p>User-friendly Navigation:Dazzling organized categories and subcategories of a
                                                sidebar menu.</p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                                <div class="col-6 font-success">40</div>
                                ...
                                <div class="row">
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-danger"><span
                                            ...
                                            <p>The design incorporates clear It focuses on simplicity error handling
                                                mechanisms.</p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                                <div class="col-6 font-danger">12 </div>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-danger"><span
                                            ...
                                            <p>Customization Options: Depending It strives to create an interface
                                                requirements, options.</p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-danger"><span
                                            ...
                                            <p> Poco admin design embraces uses ample white space a clean and minimalistic
                                                visual style.</p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-danger"><span
                                            ...
                                            <p>Attention is given to visual style and layout across different sections
                                                readability to enhance the user experience.</p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-danger"><span
                                            ...
                                            <p>Admin design pays attention to incorporating these principles form design and
                                                input elements. </p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                                <div class="col-6 font-danger">12 </div>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-danger"><span
                                            ...
                                            <p>Poco admin includes a user-friendly elements like dropdowns system of a
                                                sidebar menu.</p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                ...
                                <div class="row">
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-success"><span
                                            ...
                                            <p>The design incorporates clear highlight important elements error and feedback
                                                mechanisms.</p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-success"><span
                                            ...
                                            <p>Attention is given to readability follows a modular approach to enhance the
                                                user experience.</p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-success"><span
                                            ...
                                            <p>The grid system allows for and utilizes a grid system arrangement of
                                                elements.</p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                                <div class="col-6 font-success">40</div>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-success"><span
                                            ...
                                            <p>Admin design recognizes streamlined and uncluttered user importance of
                                                accessibility</p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                    ...
                                    <div class="col-xxl-4 col-md-6">
                                        <div class="project-box font-dark bg-light-success"><span
                                            ...
                                            <p> Consistency and Branding: The design appropriate font sizes focusing and
                                                typography.</p>
                                            <div class="row details">
                                                <div class="col-6"><span>Issues </span></div>
                                                <div class="col-6 font-success">12 </div>
...
@section('scripts')
    <script src="{{ asset('assets/js/icons/icon.js') }}"></script>
@endsection
