            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body add-post">
                        <form class="row needs-validation" id="blogForm" action="{{ route('admin.tehsil.update', $tehsil->tehsilID) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            @include('admin.tehsils.fields')
                        </form>
                    </div>
                </div>
            </div>
