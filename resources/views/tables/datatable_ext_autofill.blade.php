...
@section('main_content')
    ...
    <div class="container-fluid autofill-datatable">
        <div class="row">
            <div class="col-sm-12">
                <div class="card keytable">
                    <div class="card-header pb-0 card-no-border">
                        <h4>Keytable Integration</h4>
                        <p class="desc mb-0 mt-1"><span></span><code></code><span>If you are looking to emulate the UI of
                                spreadsheet programs such as Excel with DataTables, the combination of KeyTable and AutoFill
                                will take you a long way there!</span></p>
                    </div>
                    <div class="card-body">
                        <div class="dt-ext table-responsive">
                            <table class="display table table-striped table-hover table-light" id="keytable">
                                <thead>
                                    <tr>
                                        <th>Employee Name</th>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <h4>Multi-Level Collections</h4>
                        <p class="desc mb-0 mt-1"><span></span><code></code><span>Keyboard navigation is essential for fast
                                navigation of a table operations and also for good accessibility. Buttons provides the
                                ability to give each button a key binding i.e a key combination that when pressed will
                                activate the button action.The key binding can be given as a single character if you wish to
                                listen for an unmodified key press, or as an object if you wish it to only be activated when
                                a modifier key such as shift, alt, etc, is pressed.</span></p>
                    </div>
                    <div class="card-body">
                        <div class="dt-ext table-responsive">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <h4>Header and Footer fixed</h4>
                        <p class="desc mb-0 mt-1"><span></span><code></code><span>When displaying tables with a
                                particularly large amount of data shown on each page, it can be useful to have the table
                                header and footer fixed to the top or bottom of the scrolling window FixedHeader provides
                                the ability to fix in place both. These are controlled by the options fixedHeader.header and
                                fixedHeader.footer. Either can be optionally enabled, or as is the case in this example,
                                both enabled.</span></p>
                    </div>
                    <div class="card-body">
                        <div class="dt-ext table-responsive">
                            ...
                            <table class="display" id="export-button">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Airi Satou</td>
                                        <td>Accountant</td>
                                        <td> <img class="img-fluid table-avtar" src="{{ asset('assets/images/avatar/3.jpg') }}"
                                                alt=""></td>
                                        <td>33</td>
                                        <td>2008/11/28</td>
                                        <td>$162,700</td>
                                    ...
                                    <tr>
                                        <td>Herrod Chandler</td>
                                        <td>Sales Assistant</td>
                                        <td> <img class="img-fluid table-avtar" src="{{ asset('assets/images/avatar/6.jpg') }}"
                                                alt="profile"></td>
                                        <td>59</td>
                                        <td>2012/08/06</td>
                                        <td>$137,500</td>
                                    ...
                                    <tr>
                                        <td>Rhona Davidson</td>
                                        <td>Integration Specialist</td>
                                        <td> <img class="img-fluid table-avtar" src="{{ asset('assets/images/avatar/7.jpg') }}"
                                                alt="profile"></td>
                                        <td>55</td>
                                        <td>2010/10/14</td>
                                        <td>$327,900</td>
                                    ...
                                    <tr>
                                        <td>Colleen Hurst</td>
                                        <td>Javascript Developer</td>
                                        <td> <img class="img-fluid table-avtar" src="{{ asset('assets/images/avatar/9.jpg') }}"
                                                alt="profile"></td>
                                        <td>39</td>
                                        <td>2009/09/15</td>
                                        <td>$205,500</td>
                                    ...
                                    <tr>
                                        <td>Sonya Frost</td>
                                        <td>Software Engineer</td>
                                        <td> <img class="img-fluid table-avtar" src="{{ asset('assets/images/avatar/10.jpg') }}"
                                                alt="profile"></td>
                                        <td>23</td>
                                        <td>2008/12/13</td>
                                        <td>$103,600</td>
                                    ...
                                    <tr>
                                        <td>Jena Gaines</td>
                                        <td>Office Manager</td>
                                        <td> <img class="img-fluid table-avtar" src="{{ asset('assets/images/avatar/11.jpg') }}"
                                                alt="profile"></td>
                                        <td>30</td>
                                        <td>2008/12/19</td>
                                        <td>$90,560</td>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <h4>Immediately Show Hidden Details</h4>
                        <p class="desc mb-0 mt-1"><span></span><code></code><span>Responsive has the ability to display
                                the details that it has hidden in a variety of different ways. Its default is to allow the
                                end user to toggle the the display by clicking on a row and showing the information in a
                                DataTables child row. At times it can be useful not to require end user interaction to
                                display the hidden data in a responsive manner, which can be done with the
                                childRowImd-flexte display type.</span></p>
                    </div>
                    <div class="card-body">
                        <div class="dt-ext table-responsive">
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header pb-0 card-no-border">
                        <h4>Full row selection</h4>
                        <p class="desc mb-0 mt-1"><span></span><code></code><span>The rowReorder.selector option provides
                                the ability to define which element in a table row will provide the row reordering handle to
                                the end user. By default only the first cell in the row will trigger the reordering action.
                                This example shows the entire row being able to start the reorder. Simply click and drag
                                anywhere on the row. Additionally, the column that defines the row order is hidden by
                                default, making the table a simple orderable list.</span></p>
                    </div>
                    <div class="card-body">
                        <div class="dt-ext table-responsive">
