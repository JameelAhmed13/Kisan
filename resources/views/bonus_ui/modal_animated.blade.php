...
@section('css')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/vendors/animate-custom.css') }}">
@endsection
            ...
            <div class="col-sm-6">
                <nav>
                    <ol class="breadcrumb justify-content-sm-end align-items-center">
                        ...
                        <li class="breadcrumb-item active">Modal Animated</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <p class="desc mb-0 mt-1"><span>Use the different types of fades and animations in
                                modals.</span><code></code><span></span></p>
                    </div>
                    <div class="card-body">
                                        ...
                                        <div class="animate-widget">
                                            ...
                                            <div class="text-center p-25">
                                                <div class="text-muted mb-0">
                                                    <h4>It&apos;s Magic!!</h4>
                                                    <p>Select the animation options given below and then click on the launch
                                                        modal button.</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card">
                                            <div class="animate-widget">
                                                <div><img class="img-fluid" src="{{ asset('assets/images/slider/6.jpg') }}"
                                                        alt="Drawing-room"></div>
                                                <div class="text-center p-25">
                                                    <p class="text-muted mb-0"><strong class="font-danger">Wow!!!</strong>
                                                        It's so beautiful animations in Edmin theme...</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@section('scripts')
    <script src="{{ asset('assets/js/modal/modal-animated.js') }}"></script>
@endsection
