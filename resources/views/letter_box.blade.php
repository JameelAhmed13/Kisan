...
@section('main_content')
    ...
    <div class="container-fluid email-wrap email-main-wrapper">
        <div class="row">
                                    ...
                                    <div class="email-app-sidebar">
                                        ...
                                        <ul class="nav nav-pills main-menu email-category" id="email-pills-tab"
                                            ...
                                            <li class="nav-item"><a class="nav-link active" id="inbox-pill-tab"
                                                    ...
                                                    <svg class="feather stroke-icon">
                                                        <use
                                                            href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#inbox') }}">
                                                        </use>
                                                    </svg>
                                            ...
                                            <li class="nav-item"><a class="nav-link" id="draft-pill-tab"
                                                    ...
                                                    <svg class="feather stroke-icon">
                                                        <use
                                                            href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#edit') }}">
                                                        </use>
                                                    </svg>Draft</a></li>
                                            ...
                                            <li class="nav-item"><a class="nav-link" id="work-pill-tab"
                                                    ...
                                                    <svg class="feather stroke-primary stroke-icon">
                                                        <use
                                                            href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#briefcase') }}">
                                                        </use>
                                                    </svg>Work</a></li>
                                            <li class="nav-item"><a class="nav-link" id="private-pill-tab"
                                                    ...
                                                    <svg class="feather stroke-warning stroke-icon">
                                                        <use
                                                            href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#briefcase') }}">
                                                        </use>
                                                    </svg>Private</a></li>
                                            <li class="nav-item"><a class="nav-link" id="support-pill-tab"
                                                    ...
                                                    <svg class="feather stroke-success stroke-icon">
                                                        <use
                                                            href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#briefcase') }}">
                                                        </use>
                                                    </svg>Support</a></li>
            ...
            <div class="col-xxl-9 col-xl-8 box-col-12">
                        ...
                        <div class="mail-header-wrapper">
                            <div class="mail-header">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input checkbox-primary" id="emailCheckboxA" type="checkbox"
                                        value="option1">
                                    ...
                                    <ul class="email-tabs nav" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" data-bs-toggle="pill"
                                                ...
                                                <svg class="feather">
                                                    <use
                                                        href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#mail') }}">
                                                    </use>
                                        ...
                                        <li class="nav-item"><a class="nav-link" data-bs-toggle="pill" href="#!"
                                                ...
                                                <svg class="feather">
                                                    <use
                                                        href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#user') }}">
                                                    </use>
                                        ...
                                        <li class="nav-item"><a class="nav-link" data-bs-toggle="pill" href="#!"
                                                ...
                                                <svg class="feather">
                                                    <use
                                                        href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#wifi') }}">
                                                    </use>
                                ...
                                <div class="mail-body-wrapper">
                                    <ul id="paginated-list" data-current-page="1" aria-live="polite">
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxB"
                                                        type="checkbox" value="option1">
                                                    <label class="form-check-label" for="emailCheckboxB"></label>
                                                </div>
                                                <svg class="feather important-mail active">
                                                    <use
                                                        href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#star') }}">
                                                    </use>
                                                </svg>
                                                <div class="rounded-border"><img class="img-fluid"
                                                        src="{{ asset('assets/images/user/2.jpg') }}" alt="user"></div>
                                                <p>Marvin McKinney</p>
                                            </div>
                                            <div class="inbox-message">
                                                <div class="email-data"><span>New comments on MSR2024 draft presentation -
                                                        <span>New Here's a list of all the topic challenges...</span></span>
                                                    <div class="badge badge-light-primary">new</div>
                                                </div>
                                                <div class="email-timing"><span>2:30 PM</span></div>
                                                <div class="email-options"><i
                                                        class="fa-regular fa-envelope fa-fw envelope-1 show"></i><i
                                                        class="fa-solid fa-envelope-open fa-fw envelope-2 hide"></i><i
                                                        class="fa-solid fa-trash-can fa-fw trash-3"></i><i
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxC"
                                                        type="checkbox" value="option1">
                                                    <label class="form-check-label" for="emailCheckboxC"></label>
                                                </div>
                                                <svg class="feather important-mail">
                                                    <use
                                                        href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#star') }}">
                                                    </use>
                                                </svg>
                                                <div class="rounded-border"><img class="img-fluid"
                                                        src="{{ asset('assets/images/user/3.jpg') }}" alt="user"></div>
                                                <p>Brooklyn Simmons</p>
                                            </div>
                                            <div class="inbox-message">
                                                <div class="email-data"><span>Confirm your booking id -<span> A collection
                                                            of textile samples lay spread out on the table - Samsa was a
                                                            travelling salesman..</span></span>
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxD"
                                                        type="checkbox" value="option1">
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxE"
                                                        type="checkbox" value="option1">
                                                ...
                                                <div class="rounded-border">
                                                    <div class="circle-success">
                                                        <p class="font-success">CW</p>
                                                    </div>
                                                </div>
                                                <p>Cameron Williamson</p>
                                            </div>
                                            <div class="inbox-message">
                                                <div class="email-data"><span>Very fiction Link -<span>Nihil anim keffiyeh
                                                            helvetica, craft beer labore wes anderson cred nesciunt sapiente
                                                            ea proident.</span></span></div>
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxF"
                                                        type="checkbox" value="option1">
                                                ...
                                                <div class="rounded-border"><img class="img-fluid"
                                                        src="{{ asset('assets/images/user/6.jpg') }}  " alt="user"></div>
                                                <p>Ronald Richards</p>
                                            </div>
                                            <div class="inbox-message">
                                                <div class="email-data"><span>Confirm your booking id -<span>Confirm your
                                                            booking id - A collection of textile samples lay spread out on
                                                            the table - Samsa was a travelling salesman..</span></span>
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxG"
                                                        type="checkbox" value="option1">
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxH"
                                                        type="checkbox" value="option1">
                                                ...
                                                <div class="rounded-border"><img class="img-fluid"
                                                        src="{{ asset('assets/images/user/15.jpg') }}" alt="user"></div>
                                                <p>Jacob Jones</p>
                                            </div>
                                            <div class="inbox-message">
                                                <div class="email-data"><span>Welcome to our new office -<span>A collection
                                                            of textile samples lay spread out on the table - Samsa was a
                                                            travelling salesman..</span></span></div>
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxI"
                                                        type="checkbox" value="option1">
                                                ...
                                                <div class="rounded-border"><img class="img-fluid"
                                                        src="{{ asset('assets/images/user/14.jpg') }}" alt="user"></div>
                                                <p>Ralph Edwards</p>
                                            </div>
                                            <div class="inbox-message">
                                                <div class="email-data"><span>Your Order #224820098 has been
                                                        Confirmed-<span>A collection of textile samples lay spread out on
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxJ"
                                                        type="checkbox" value="option1">
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxK"
                                                        type="checkbox" value="option1">
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxL"
                                                        type="checkbox" value="option1">
                                                ...
                                                <div class="rounded-border"><img class="img-fluid"
                                                        src="{{ asset('assets/images/user/13.jpg') }}" alt="user"></div>
                                                <p>Jacob Jones</p>
                                            </div>
                                            <div class="inbox-message">
                                                <div class="email-data"><span>Welcome to our new office -<span>A collection
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxM"
                                                        type="checkbox" value="option1">
                                                ...
                                                <div class="rounded-border"><img class="img-fluid"
                                                        src="{{ asset('assets/images/user/12.jpg') }}" alt="user"></div>
                                                <p>Ralph Edwards</p>
                                            </div>
                                            <div class="inbox-message">
                                                <div class="email-data"><span>Your Order #224820098 has been
                                ...
                                <div class="mail-body-wrapper">
                                    <ul>
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxN"
                                                        type="checkbox" value="option1">
                                                ...
                                                <div class="rounded-border"><img class="img-fluid"
                                                        src="{{ asset('assets/images/user/11.jpg') }}" alt="user"></div>
                                                <p>Brooklyn Simmons</p>
                                            </div>
                                            <div class="inbox-message">
                                                <div class="email-data"><span>Confirm your booking id -<span> A collection
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxO"
                                                        type="checkbox" value="option1">
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxP"
                                                        type="checkbox" value="option1">
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxQ"
                                                        type="checkbox" value="option1">
                                ...
                                <div class="mail-body-wrapper">
                                    <ul>
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxR"
                                                        type="checkbox" value="option1">
                                                ...
                                                <div class="rounded-border"><img class="img-fluid"
                                                        src="{{ asset('assets/images/user/7.jpg') }}" alt="user"></div>
                                                <p>Marvin McKinney</p>
                                            </div>
                                            <div class="inbox-message">
                                                <div class="email-data"><span>New comments on MSR2024 draft presentation -
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxS"
                                                        type="checkbox" value="option1">
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxT"
                                                        type="checkbox" value="option1">
                                ...
                                <div class="mail-body-wrapper">
                                    <ul>
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxU"
                                                        type="checkbox" value="option1">
                                                ...
                                                <div class="rounded-border"><img class="img-fluid"
                                                        src="{{ asset('assets/images/user/9.jpg') }}" alt="user"></div>
                                                <p>Ralph Edwards</p>
                                            </div>
                                            <div class="inbox-message">
                                                <div class="email-data"><span>Your Order #224820098 has been
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxV"
                                                        type="checkbox" value="option1">
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxW"
                                                        type="checkbox" value="option1">
                                                ...
                                                <div class="rounded-border"><img class="img-fluid"
                                                        src="{{ asset('assets/images/user/8.jpg') }}" alt="user"></div>
                                                <p>Jacob Jones</p>
                                            </div>
                                            <div class="inbox-message">
                                                <div class="email-data"><span>Welcome to our new office -<span>A collection
                                ...
                                <div class="mail-body-wrapper">
                                    <ul>
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxX"
                                                        type="checkbox" value="option1">
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxY"
                                                        type="checkbox" value="option1">
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckboxZ"
                                                        type="checkbox" value="option1">
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckbox0"
                                                        type="checkbox" value="option1">
                                ...
                                <div class="mail-body-wrapper">
                                    <ul>
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckbox77"
                                                        type="checkbox" value="option1">
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckbox22"
                                                        type="checkbox" value="option1">
                                        ...
                                        <li class="inbox-data">
                                            <div class="inbox-user">
                                                <div class="form-check form-check-inline m-0">
                                                    <input class="form-check-input checkbox-primary" id="emailCheckbox33"
                                                        type="checkbox" value="option1">
                    ...
                    <div class="card email-body email-read">
                        <div class="mail-header-wrapper header-wrapper1">
                            <div class="mail-header1">
                                <div class="light-square">
                                    <svg class="feather btn-email">
                                        <use
                                            href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#arrow-left') }}">
                                        </use>
                                    </svg>
                            ...
                            <div class="mail-body1">
                                <div class="light-square" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <svg class="feather">
                                        <use href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#mail') }}">
                                        </use>
                                    </svg>
                                </div>
                                <div class="light-square" data-bs-toggle="tooltip" data-bs-placement="top"
                                    data-bs-title="Bookmark">
                                    <svg class="feather bookmark-box">
                                        <use
                                            href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#bookmark') }}">
                                        </use>
                                    </svg>
                                </div>
                                <div class="light-square" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                <div class="light-square" data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <svg class="feather">
                                        <use
                                            href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#settings') }}">
                                        </use>
                                    </svg>
                                </div>
                            </div>
                        ...
                        <div class="mail-body-wrapper">
                            <div class="user-mail-wrapper">
                                    ...
                                    <div>
                                        ...
                                        <div class="dropdown-subtitle">
                                            ...
                                            <div class="onhover-dropdown">
                                                <button class="btn p-0 dropdown-button">To me
                                                    <svg class="feather">
                                                        <use
                                    ...
                                    <div class="inbox-options"> <span>Friday 07 Apr (4 hours ago)</span>
                                        ...
                                        <div class="light-square btn-group">
                                            <div class="dropdown-toggle" data-bs-toggle="dropdown"
                                                ...
                                                <svg class="feather">
                                                    <use
                                                        href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#menu') }}">
                                                    </use>
                                                </svg>
                                            </div>
                                ...
                                <div class="user-body">
                                    <p>Dear Customer,</p>
                                    <p>We regret to notify you that an unauthorized attempt was made to access your account.
                                        Our system discovered suspicious activity, and we acted right away to safeguard your
                                        personal data.</p>
                                    <p>Please change your login information by clicking the following link in order to
                                        safeguard your account:</p>
                                    <p>Please be aware that your account may be temporarily suspended if no action is taken
                                        within 24 hours. We urge you to take immediate action to prevent any inconvenience.
                                    </p>
                                    <p>We sincerely apologize for any inconvenience this may cause and thank you for your
                                ...
                                <div class="user-footer">
                                    <div>
                                        ...
                                        </svg><span class="font-light">Attachments</span>
                                    </div>
                                    <div class="d-inline-block">
                                        <div class="attchment-file common-flex">
                                            <div class="common-flex align-items-center"><img
                                                    src="{{ asset('assets/images/email-template/pdfs.png') }}" alt="pdf">
                                                <div class="d-block">
                                                    <p>Offer_Letter.pdf</p>
                                                    <p>200KB</p>
                                                </div>
                                            </div><a href="{{ asset('assets/pug/pages/template/text_file.font') }}" download> <i
                                                    class="fa fa-download font-light"></i></a>
                                        </div>
                                    </div>
                ...
                <div class="modal fade" id="compose_mail" tabindex="-1" aria-labelledby="compose_mailLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h3 class="modal-title fs-5" id="compose_mailLabel">Compose Message</h3>
                                    ...
                                    <div class="modal-footer">
                                        <button class="btn bg-light-primary" type="button">Save as draft</button>
                        ...
                        <div class="modal fade" id="label-pill" tabindex="-1" aria-labelledby="label-pillLabel"
                                aria-hidden="true">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title fs-5" id="label-pillLabel">Add Label</h3>
                                            <button class="btn-close" type="button" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form>
                                                <div class="row g-sm-3 g-2 custom-input">
                                                    ...
                                                    <label class="col-sm-2 col-form-label" for="Email_Modal">Email
                                                        :</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" id="Email_Modal" type="email">
                                                    </div>
                                                    <label class="form-label col-sm-2" for="exampleColorInput">Label
                                                        Color :</label>
                                                    <div class="col-sm-2 col-2">
                                                        <input class="form-control form-control-color"
                                                            id="exampleColorInput" type="color" value="#43B9B2"
                                        ...
                                        <div class="modal-footer">
                                            <button class="btn bg-light-primary" type="button"
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/letter-box/custom-letter-quill.js') }}"></script>
