...
@section('css')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/vendors/uikit/dist/css/uikit.min.css') }}">
@endsection
                        ...
                        <div class="tab-content" id="chat-options-tabContent">
                            <div class="tab-pane fade show active" id="chats" role="tabpanel"
                                ...
                                <ul class="chats-user">
                                    ...
                                    <li class="common-space">
                                        <div class="chat-time">
                                            <div class="active-profile"><img class="img-fluid rounded-circle"
                                                    src="{{ asset('assets/images/avatar/9.jpg') }}" alt="user">
                                                <div class="status bg-warning"></div>
                                            </div>
                            ...
                            <div class="tab-pane fade" id="contacts" role="tabpanel" aria-labelledby="contacts-tab">
                                ...
                                <div class="search-contacts">
                                    <input class="form-control" type="text" placeholder="Name and phone number"><i
                                ...
                                <div class="contact-wrapper">
                                    ...
                                    <ul class="border-0">
                                        <li class="common-space">
                                            ...
                                            <div class="contact-edit"><i class="fa-solid fa-bars dropdown-toggle"
                                                    role="menu" data-bs-toggle="dropdown" aria-expanded="false"></i>
                                    ...
                                    <ul class="border-0">
                                        ...
                                        <li class="common-space">
                                            <div class="chat-time"><img class="img-fluid rounded-circle"
                                                    src="{{ asset('assets/images/user/5.jpg') }}" alt="user">
                                    ...
                                    <ul class="border-0">
                                        <li class="common-space">
                                            <div class="chat-time"><img class="img-fluid rounded-circle"
                                                    src="{{ asset('assets/images/user/7.jpg') }}" alt="user">
                                    ...
                                    <ul class="border-0">
                                        <li class="common-space">
                                            <div class="chat-time"><img class="img-fluid rounded-circle"
                                                    src="{{ asset('assets/images/user/8.jpg') }}" alt="user">
                    ...
                    <div class="right-sidebar-title">
                        <div class="common-space">
                            <div class="chat-time group-chat">
                                <ul>
                                    <li><img class="img-fluid rounded-circle" src="{{ asset('assets/images/avatar/1.jpg') }}"
                                            alt="user"></li>
                                    <li><img class="img-fluid rounded-circle" src="{{ asset('assets/images/avatar/2.jpg') }}"
                                            alt="user"></li>
                                    <li><img class="img-fluid rounded-circle" src="{{ asset('assets/images/avatar/3.jpg') }}"
                                            alt="user"></li>
                                    <li><img class="img-fluid rounded-circle" src="{{ asset('assets/images/avatar/4.jpg') }}"
                                            alt="user"></li>
                                    <li><img class="img-fluid rounded-circle" src="{{ asset('assets/images/avatar/5.jpg') }}"
                                            alt="user"></li>
                                    <li><img class="img-fluid rounded-circle" src="{{ asset('assets/images/avatar/6.jpg') }}"
                                            alt="user"></li>
                                    <li><img class="img-fluid rounded-circle" src="{{ asset('assets/images/avatar/7.jpg') }}"
                                            alt="user"></li>
                                    <li>
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <div class="contact-edit chat-alert"><i class="fa-solid fa-bars dropdown-toggle"
                                        role="menu" data-bs-toggle="dropdown" aria-expanded="false"></i>
                                    <div class="dropdown-menu dropdown-menu-end"><a class="dropdown-item"
                            ...
                            <div class="msger-chat">
                                <div class="msg left-msg">
                                    ...
                                    <div class="msg-bubble">
                                        ...
                                        <div class="msg-text">Hey, I'm looking to redesign my website. Can you help me?
                                            &#x1F604;</div>
                                    </div>
                                </div>
                                ...
                                <div class="msg left-msg">
                                    ...
                                    <div class="msg-bubble">
                                        ...
                                        <div class="msg-text">I want a clean and modern look with a focus on user
                                            experience.</div>
                                    </div>
                                </div>
                                <div class="msg right-msg">
                                ...
                                <div class="msg right-msg">
                                    ...
                                    <div class="msg-bubble">
                                        ...
                                        <div class="msg-text">Excellent choice! Those colors can definitely create a
                                            professional.</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="dropdown-form dropdown-toggle" role="main" data-bs-toggle="dropdown"
                                    ...
                                    <div class="chat-icon dropdown-menu dropdown-menu-start">
                                        <div class="dropdown-item mb-2">
                                            <svg class="feather">
                                                <use href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#camera') }}">
                                                </use>
                                            </svg>
                                        </div>
                                        <div class="dropdown-item">
                                            <svg class="feather">
                                                <use href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#paperclip') }}">
                                                </use>
                                            </svg>
                                        </div>
                                    </div>
...
@section('scripts')
    <script src="{{ asset('assets/js/vendors/uikit/dist/js/uikit.min.js') }}"></script>
