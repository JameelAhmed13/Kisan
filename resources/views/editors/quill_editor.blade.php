...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/custom-quill.js') }}"></script>
    <script src="{{ asset('assets/js/vendors/quill/dist/quill.min.js') }}"></script>
@endsection
