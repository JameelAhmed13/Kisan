            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header pb-0">
                        ...
                        <p class="desc mb-0 mt-1"><span></span><code></code><span>Fill up your true details and next
                                proceed.</span></p>
                    </div>
                    <div class="card-body">
                                    ...
                                    <div class="tab-content" id="wizard-tabContent">
                                        <div class="tab-pane fade show active" id="wizard-contact" role="tabpanel"
                                            ...
                                            <form class="row g-3 needs-validation custom-input" novalidate="">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-check checkbox-checked form-check-inline">
                                                        <input class="form-check-input" id="invalidCheck-9"
                                                            type="checkbox" value="" required="">
                                                        <label class="form-check-label" for="invalidCheck-9">Agree to
                                        ...
                                        <div class="tab-pane fade" id="wizard-cart" role="tabpanel"
                                            ...
                                            <form class="row g-3 needs-validation custom-input" novalidate="">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-check checkbox-checked form-check-inline mb-0">
                                                        <input class="form-check-input" id="invalidCheck-7"
                                                            type="checkbox" value="" required="">
                                                        <label class="form-check-label" for="invalidCheck-7">All the above
                                        ...
                                        <div class="tab-pane fade custom-input" id="wizard-banking" role="tabpanel"
                                            ...
                                            <form class="row g-3 mb-3 needs-validation" novalidate="">
                                                    ...
                                                    <div class="accordion dark-accordion" id="accordionExample-a">
                                                        <div class="accordion-item">
                                                            <h2 class="accordion-header" id="headingOne-a">
                                                                <button
                                                                    class="accordion-button collapsed accordion-light-primary font-primary"
                                                                    ...
                                                                    <div class="row choose-bank">
                                                                        <div class="col-sm-6">
                                                                            <div class="form-check radio">
                                                                                <label class="d-block"
                                                                                    for="flexRadioDefault-z">
                                                                                    <input class="radio-primary"
                                                                                        id="flexRadioDefault-z"
                                                                                        type="radio"
                                                                                        name="flexRadioDefault-v">Industrial
                                                                                    & Commercial Bank
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-check radio">
                                                                                <label class="d-block"
                                                                                    for="flexRadioDefault-y">
                                                                                    <input class="radio-primary"
                                                                                        id="flexRadioDefault-y"
                                                                                        type="radio"
                                                                                        name="flexRadioDefault-v">Agricultural
                                                                                    Bank
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-check radio">
                                                                                <label class="d-block"
                                                                                    for="flexRadioDefault-x">
                                                                                    <input class="radio-primary"
                                                                                        id="flexRadioDefault-x"
                                                                                        type="radio"
                                                                                        name="flexRadioDefault-v"
                                                                                        checked="">JPMorgan Chase & Co.
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-sm-6">
                                                                            <div class="form-check radio">
                                                                                <label class="d-block"
                                                                                    for="flexRadioDefault-w">
                                                                                    <input class="radio-primary"
                                                                                        id="flexRadioDefault-w"
                                                                                        type="radio"
                                                                                        name="flexRadioDefault-v">Construction
                                                                                    Bank Corp.
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-check radio">
                                                                                <label class="d-block"
                                                                                    for="flexRadioDefault-v">
                                                                                    <input class="radio-primary"
                                                                                        id="flexRadioDefault-v"
                                                                                        type="radio"
                                                                                        name="flexRadioDefault-v">Bank of
                                                                                    America
                                                                                </label>
                                                                            </div>
                                                                            <div class="form-check radio">
                                                                                <label class="d-block"
                                                                                    for="flexRadioDefault-u">
                                                                                    <input class="radio-primary"
                                                                                        id="flexRadioDefault-u"
                                                                                        type="radio"
                                                                                        name="flexRadioDefault-v">HDFC Bank
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-check checkbox-checked form-check-inline mb-0">
                                                        <input class="form-check-input" id="invalidCheck-8"
                                                            type="checkbox" value="" required="">
                                                        <label class="form-check-label" for="invalidCheck-8">Agree to
                                                            terms and conditions</label>
                                                        <div class="invalid-feedback">You must agree before submitting.
                                                        </div>
                                                    </div>
                            ...
                            <div class="col-12">
                                <div class="row shipping-form g-5">
                                    <div class="col-xl-8 shipping-border">
                                        <div class="nav nav-pills horizontal-options shipping-options bg-light-primary"
                                            id="cart-options-tab" role="tablist" aria-orientation="vertical"><a
                                                ...
                                                aria-selected="false">
                                                <div class="cart-options">
                                                    <div class="stroke-icon-wizard"><i class="fa-solid fa-money-bill"></i>
                                                    </div>
                                                    <div class="cart-options-content">
                                                        <h6>Payment</h6>
                                                    </div>
                                        ...
                                        <div class="tab-content dark-field shipping-content" id="cart-options-tabContent">
                                            <div class="tab-pane fade show active" id="bill-wizard" role="tabpanel"
                                                ...
                                                <p class="mb-3">Fill up the following information </p>
                                            ...
                                            <div class="tab-pane fade shipping-wizard" id="ship-wizard" role="tabpanel"
                                                ...
                                                <p class="font-light">Fill up the following information to send you the
                                                    order</p>
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-xxl-4 col-sm-6">
                                                        <div class="card-wrapper solid-border rounded-3 h-100 light-card">
                                                            <div class="collect-address">
                                                                <div class="d-flex gap-2 align-items-center">
                                                                    <div class="form-check radio">
                                                                        <label class="d-block" for="shipping-choose1">
                                                                            <input class="radio-primary"
                                                    ...
                                                    <div class="col-xxl-4 col-sm-6">
                                                        <div class="card-wrapper solid-border rounded-3 h-100 light-card">
                                                            <div class="collect-address">
                                                                <div class="d-flex gap-2 align-items-center">
                                                                    <div class="form-check radio">
                                                                        <label class="d-block" for="shipping-choose2">
                                                                            <input class="radio-primary"
                                                ...
                                                <div class="row shipping-method g-3">
                                                    <div class="col-sm-6">
                                                        <div class="card-wrapper solid-border rounded-3 h-100 light-card">
                                                            <div class="form-check radio">
                                                                <label class="d-block" for="shipping-choose3">
                                                                    <input class="radio-primary" id="shipping-choose3"
                                                                        type="radio" name="radio1"
                                                                        value="option1">Standard Delivery - Free
                                                                </label>
                                                            </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="card-wrapper solid-border rounded-3 h-100 light-card">
                                                            <div class="form-check radio">
                                                                <label class="d-block" for="shipping-choose4">
                                                                    <input class="radio-primary" id="shipping-choose4"
                                                                        type="radio" name="radio2" value="option1"
                                                                        checked="">Express Delivery - $24
                                                                </label>
                                                            </div>
                                            ...
                                            <div class="tab-pane fade shipping-wizard" id="payment-wizard"
                                                ...
                                                <div class="payment-info-wrapper">
                                                    <div class="row shipping-method g-3">
                                                        <div class="col-12">
                                                            <div class="card-wrapper solid-border rounded-3 light-card">
                                                                <div>
                                                                    <div class="form-check-size">
                                                                        <label class="d-block">
                                                                            <input class="radio-primary" id="radio-ani_99"
                                                                                type="radio" name="radio5">Paypal
                                                                        </label>
                                                                    </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div
                                                                class="card-wrapper solid-border rounded-3 pay-info light-card">
                                                                <div>
                                                                    <div>
                                                                        <div class="form-check-size">
                                                                            <label class="d-block">
                                                                                <input class="radio-primary"
                                                                                    id="radio-ani_88" type="radio"
                                                                                    name="radio5">Credit Card
                                                                            </label>
                                                                        </div>
                                                            ...
                                                            <div class="card-wrapper solid-border rounded-3 light-card">
                                                                <div>
                                                                    <div class="form-check-size">
                                                                        <label class="d-block">
                                                                            <input class="radio-primary"
                                                                                id="radio-ani_33" type="radio"
                                                                                name="radio5">Cash On Delivery
                                                                        </label>
                                                                    </div>
                                            ...
                                            <div class="tab-pane fade shipping-wizard finish-wizard1" id="finish-wizard"
                                                ...
                                                <div class="order-confirm"><img
                                                        src="{{ asset('assets/images/gif/successful.gif') }}" alt="popper">
                                                    ...
                                                    <p class="text-center f-w-500 mt-2">Order ID: <a
                                            ...
                                            <div class="overflow-auto">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td> <img src="{{ asset('assets/images/email-template/4.png') }}"
                                                                    alt="headphone"></td>
                                                            <td>
                                                                <div>
                                                        ...
                                                        <tr>
                                                            <td> <img src="{{ asset('assets/images/product/3.png') }}"
                                                                    alt="headphone"></td>
                                                            <td>
                                                                <div>
