                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body main-qr-code">
                                        <div class="modal-toggle-wrapper">
                                            ...
                                            <div class="modal-img">
                                                <div class="qr-img"><img src="{{ asset('assets/images/forms/qr-code.png') }}"
                                                        alt="qr-code"></div>
                                ...
                                <div class="card-wrapper solid-border rounded-3 h-100">
                                    <div class="authenticate">
                                        <h4>Verification code</h4><img class="img-fluid"
                                            src="{{ asset('assets/images/forms/authenticate.png') }}" alt="authenticate"><span>We've
                                            sent a verification code to</span><span>+91********70</span>
                                        <form class="row">
                                            <div class="col">
                                                <h4>Your OTP Code here:</h4>
                                            </div>
                                            ...
                                            <div> <span>Not received your code?</span><span><a class="font-primary"
                                                        href="javascript:void(0)">Resend </a>OR <a class="font-primary"
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/two-factor/factor-custom.js') }}"></script>
@endsection
