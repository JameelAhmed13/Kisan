                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex gap-2 align-items-center">
                                            <div class="flex-shrink-0"> <img class="img-fluid img-42 b-r-10"
                                                    src="{{ asset('assets/images/avatar/13.jpg') }}" alt="">
                                            </div>
                                            <div class="flex-grow-1"> <a href="{{ route('admin.user_profile') }}">
                            ...
                            <div class="col-6">
                                ...
                                <div class="main-box border-primary mx-auto">
                                    <svg class="svg-w-24 fill-primary">
                                        <use href="{{ asset('assets/svg/iconly-sprite.svg#shopping-bag') }}"></use>
                                    </svg>
                                </div>
                                <hr>
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="bg-light-primary rounded">
                                        <svg class="feather">
                                            <use
                                                href="{{ asset('assets/svg/feather-icons/dist/feather-sprite.svg#plus') }}">
                                            </use>
                                        </svg>
                                    </div>
                                </div>
